---
answer_for: "Q00020604"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "explicit-answer"
answer_source_body_sha256: daaf194fae30b824e413aca0e4a2e83bafcab5fecfb2c15f82eadaf9f419000e
---
...
>
> > [!note]- **【解析】**
> > 对于A：设曲线上的动点 $P(x,y)$ ，则 $\chi > - 2$ 且 $\sqrt{(x - 2)^2 + y^2} \times |x - a| = 4$
> >
> > 因为曲线过坐标原点，故 $\sqrt{(0 - 2)^2 + 0^2} \times |0 - a| = 4$ ，解得 $a = -2$ ，故A正确.
> >
...
> >
> > 对于D：当点 $(x_0,y_0)$ 在曲线上时，由C的分析可得 $y_0^2 = \frac{16}{(x_0 + 2)^2} - (x_0 - 2)^2\leq \frac{16}{(x_0 + 2)^2},$
> >
> > 故 $-\frac{4}{x_0 + 2} \leq y_0 \leq \frac{4}{x_0 + 2}$ ，故D正确
> >
> > 故选：ABD.
> >
