---
answer_for: "Q00021381"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "explicit-answer"
answer_source_body_sha256: b299d745f2e222f8310c2392131f485a4e438432ed46f9cc3891de3bfec76b3b
---

> [!faq]- 精品解析：2024年北京高考数学真题（解析版）解析
>
> > [!success]- **【答案】** （1） $\frac{x^{2}}{4}+\frac{y^{2}}{2}=1,e=\frac{\sqrt{2}}{2}$ (2) t = 2 【
>
> > [!note]- **【分析】**
> > （1）由题意得 $b = c = \sqrt{2}$ ，进一步得 $a$ ，由此即可得解；
> > (2) 设 $AB: y = kx + t, (k \neq 0, t > \sqrt{2})$ ， $A(x_1, y_1), B(x_2, y_2)$ ，联立椭圆方程，由韦达定理有
>
> > [!note]- **【解析】**
...
> >
> > ![](../../../images/combined/390dff853b21c01d8d85fb478e6ed2fbe422bbad7eea3eb53eb4e542148e851e.jpg)
> >
> > 从而设 $AB: y = kx + t, (k \neq 0, t > \sqrt{2})$ ， $A(x_{1}, y_{1}), B(x_{2}, y_{2})$
> >
> > 联立 $\left\{ \begin{array}{l} \frac{x^2}{4} + \frac{y^2}{2} = 1 \\ y = kx + t \end{array} \right.$ ，化简并整理得 $(1 + 2k^2)x^2 + 4ktx + 2t^2 - 4 = 0$
> >
