...
answer_source_body_sha256: 226d398829b60f2f5503d2914cab0dd1da84a71b3b486b35b476a9047242d256
---

> [!faq]- 2013年全国统一高考数学试卷（文科）（新课标ⅱ）（含解析版）解析
>
> > [!success]- **【答案】** （12分）如图，直三棱柱 $\mathrm{ABC - A_1B_1C_1}$ 中，D，E分别是AB， $\mathrm{BB}_1$ 的中点
>
> > [!note]- **【分析】**
> > （Ⅰ）连接 $AC_{1}$ 交 $A_{1}C$ 于点 F，则 DF 为三角形 $ABC_{1}$ 的中位线，故 $DF\parallel BC_{1}$ . 再
>
> > [!note]- **【解析】**
> > 解：（Ⅰ）证明：连接 $AC_{1}$ 交 $A_{1}C$ 于点 F，则 F 为 $AC_{1}$ 的中点.
> >
