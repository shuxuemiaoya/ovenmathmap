...
answer_source_body_sha256: 0133881cc002fd539b0665e4a62fa02d4b13d5c32590a1da44442e07048afd9e
---
...
>
> > [!note]- **【解析】**
> > 分析】根据题意, 可得抛物线焦点为 F(1,0), 由此设直线 l 方程为 y=k(x-1)
> >
> > 与抛物线方程联解消去 $x$ ，得 $\frac{k}{4} y^2 - y - k = 0$ 。再设 $A(x_1, y_1), B(x_2, y_2)$ ，由根与
> >
> > 系数的关系和 $|AF|=3|BF|$ ，建立关于 $y_{1}$ 、 $y_{2}$ 和k的方程组，解之可得k值，从而
> >
> > 得到直线I的方程.
> >
> > 【
> > 解答】解：∵抛物线 C 方程为 $y^{2}=4x$ ，可得它的焦点为 F（1，0），
> >
> > ∴设直线l方程为 y=k (x - 1)
> >
