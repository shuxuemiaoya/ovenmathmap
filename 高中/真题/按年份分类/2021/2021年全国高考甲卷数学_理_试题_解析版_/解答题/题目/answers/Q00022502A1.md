---
answer_for: "Q00022502"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "explicit-answer"
answer_source_body_sha256: c37e068dfd1fe920364002bb666aaacbbb2d07dda2c8327a05b3fcc5b156e705
---
...
> >
> > 所以 $\left\{\begin{aligned}m_{-}\cdot EF&=0\\ m\cdot DE&=0\end{aligned}\right.$ ，即 $\left\{\begin{aligned}-x+y+z&=0\\ (1-a)x+y-2z&=0\end{aligned}\right.$
> >
...
> > $$
> >
> > 当 $a = \frac{1}{2}$ 时， $2a^2 - 2a + 4$ 取最小值为 $\frac{27}{2}$ ，
> >
