---
answer_for: "Q00030846"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "explicit-answer"
answer_source_body_sha256: 607c1846d62061d5fd032c5d8fe452a6bda521cf8330b0eb9ffb94f7f8b54eea
---

> [!faq]- 精品解析：2025年高考天津卷数学真题（解析版）解析
>
> > [!success]- **【答案】** （1）证明见解析 (2) $\frac{4}{5}$ (3) $\frac{32}{3}$
>
> > [!note]- **【分析】**
> > （1）法
> > 一、利用正方形的性质先证明 $FG \perp BF$ ，再结合正方体的性质得出 $EF \perp$ 平面 $BCC_{1}B_{1}$ ，利用线面垂直的性质与判定定理证明即可；法
> > 二、建立空间直角坐标系，利用空间向量证明线面垂直即可；
> > (2) 利用空间向量计算面面夹角即可；
...
> >
> > 由
> > （1）知 $EF \perp$ 平面 $BCC_{1}B_{1}$ ， $FB \subset$ 平面 $BCC_{1}B_{1}$ ， $\therefore EF \perp FB$ ，
> >
