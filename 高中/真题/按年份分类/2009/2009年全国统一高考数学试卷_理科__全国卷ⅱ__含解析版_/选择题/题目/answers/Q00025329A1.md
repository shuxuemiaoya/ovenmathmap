...
>
> > [!note]- **【解析】**
> > 分析】由 $BA_{1}\parallel CD_{1}$ ，知 $\angle A_{1}BE$ 是异面直线 BE 与 $CD_{1}$ 所形成角，由此能求出异面直线 BE 与 $CD_{1}$ 所形成角的余弦值.
> >
> > 【
> > 解答】解：∵正四棱柱 $ABCD-A_{1}B_{1}C_{1}D_{1}$ 中， $AA_{1}=2AB$ ，E 为 $AA_{1}$ 中点，
> >
