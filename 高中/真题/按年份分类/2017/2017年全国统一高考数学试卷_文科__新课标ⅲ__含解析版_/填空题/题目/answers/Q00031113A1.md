---
answer_for: "Q00031113"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "explicit-answer"
answer_source_body_sha256: 53f949c8cc7322e18d827901bb1a0259acaf332bf479b28ac80bd71189811058
---

> [!faq]- 2017年全国统一高考数学试卷（文科）（新课标ⅲ）（含解析版）解析
>
> > [!success]- **【答案】** （12 分）如图四面体 ABCD 中，△ABC 是正三角形，AD=CD
>
> > [!note]- **【分析】**
...
> >
> > ∵BE=ED, ∴ $S_{\triangle DCE}=S_{\triangle BCE}$ ,
> >
...
> >
> > $$
> > \therefore \overrightarrow {C E} = (1, \sqrt {3} \lambda , 1 - \lambda), \overrightarrow {A E} = (- 1, \sqrt {3} \lambda , 1 - \lambda),
> > $$
> >
> > $$
