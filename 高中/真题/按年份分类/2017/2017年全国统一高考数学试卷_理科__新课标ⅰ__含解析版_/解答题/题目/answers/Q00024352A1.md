...
answer_source_body_sha256: fc806c04dbf7a2b6a0ecf4036fa6ac2c4923b853159cc8e7cd7279eb0c14211f
---
...
>
> > [!note]- **【解析】**
> > 分析】（1）根据三角形面积公式和正弦定理可得
> > 答案，
> >
> > (2) 根据两角余弦公式可得 $\cos A = \frac{1}{2}$ , 即可求出 $A = \frac{\pi}{3}$ , 再根据正弦定理可得 $bc = 8$ ,
> >
> > 根据余弦定理即可求出 $b+c$ ，问题得以解决。
> >
> > 【
> > 解答】解：（1）由三角形的面积公式可得 $S_{\triangle ABC}=\frac{1}{2}ac\sin B=\frac{a^{2}}{3\sin A}$ ,
> >
> > ∴3csinBsinA=2a,
> >
