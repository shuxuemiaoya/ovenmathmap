---
answer_for: "Q00029736"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "publisher-solution"
answer_source_body_sha256: 9b3733069bee45f1eabefab736f324625e45dd074922d5bdf475f054b0b70924
---
...
>
> > [!note]- **【解析】**
> > （1）记 $x_{1} < x_{2}$ ，若 $f(x_{1}) \leq f(x_{2})$ ， $f(x) = ax^{3} + 1$
> >
...
> > $$
> >
> > 必有 $g(x_{0})=M=g(x_{0}-N_{2}T_{h})$ ，且 $f(x_{0})=f(x_{0}-N_{2}T_{h})=c$ ，而由第
> > （2）问证明可知对
> >
