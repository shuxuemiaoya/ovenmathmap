---
answer_for: "Q00026832"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "publisher-solution"
answer_source_body_sha256: c32fd3491d9bb472238a602467cde87aff37c6ed8999352adff3685893ba490d
---
...
>
> > [!note]- **【解析】**
> > 分析】（1）利用弦切角定理可得： $\angle ACP = \angle ABC$ 。利用圆的性质可得 $\angle ACB = 90^{\circ}$ 。
> >
> > 再利用三角形内角和定理即可证明.
> >
> > (2) 由 (1) 可得: $\triangle APC \sim \triangle ACB$ , 即可证明.
> >
> > 【
...
> >
> > (2) 由 (1) 可得: $\triangle APC \sim \triangle ACB$ ,
> >
> > $$
