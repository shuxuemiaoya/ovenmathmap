...
>
> > [!note]- **【解析】**
> > 解：根据题意，设 $P(x_{0}, y_{0})$ ，则有 $x_{0}^{2} + y_{0}^{2} = 50$ ，
> >
> > $$
...
> >
> > 结合图形分析可得：点 P 的横坐标 $x_{0}$ 的取值范围是 $[-5\sqrt{2}, 1]$ ,
> >
> > 故答案为： $[-5\sqrt{2}, 1]$ .
> >
