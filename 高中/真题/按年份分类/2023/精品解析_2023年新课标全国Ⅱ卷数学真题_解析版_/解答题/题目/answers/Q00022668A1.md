---
answer_for: "Q00022668"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "explicit-answer"
answer_source_body_sha256: 5dffb8b3ec3b6198d5355957f484a6257623e7f7502ece7ee37deb1a14c6079e
---
...
> >
> > 由（1）可得 $f^{\prime}(x) = -b\sin (bx) - \frac{2x}{x^{2} - 1} > -b^{2}x - \frac{2x}{x^{2} - 1} = \frac{x(b^{2}x^{2} + 2 - b^{2})}{1 - x^{2}}$
> >
...
> >
> > 由（1）可得 $f^{\prime}(x) = -b\sin bx - \frac{2x}{x^{2} - 1} < -b(bx - b^{2}x^{2}) - \frac{2x}{x^{2} - 1} = \frac{x}{1 - x^{2}} (-b^{3}x^{3} + b^{2}x^{2} + b^{3}x + 2 - b^{2}),$
> >
