---
answer_for: "Q00028912"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "explicit-answer"
answer_source_body_sha256: 42e02bc28fd79fcd4cefaaf340c18a0684b712c0acded6ae912c4ba8ef4fc8a4
---

> [!faq]- 2019年全国统一高考数学试卷（理科）（新课标ⅰ）（含解析版）解析
>
> > [!success]- **【答案】** 为：2. 【点评】本题考查双曲线的简单性质, 考查数形结合的解题思想方法, 考查计算能力, 是中档题. ##
>
> > [!note]- **【分析】**
> > 由题意画出图形, 结合已知可得 $F_{1}B \perp OA$ , 写出 $F_{1}B$ 的方程, 与 $y = \frac{b}{a}x$ 联立求得 B 点坐标, 再由斜边的中线等于斜边的一半求解.
>
> > [!note]- **【解析】**
> > 分析】由题意画出图形, 结合已知可得 $F_{1}B \perp OA$ , 写出 $F_{1}B$ 的方程, 与 $y = \frac{b}{a}x$ 联立求得 B 点坐标, 再由斜边的中线等于斜边的一半求解.
> >
> > 【
> > 解答】解：如图，
> >
