...
answer_source_body_sha256: bd74494b50973915c71f1397d55c40eadd296f20447ffaa7ee6a64ba2e149ccb
---
...
> >
> > 法二：(1) 以 $D$ 为原点， $DA$ 为 $x$ 轴， $DE$ 为 $y$ 轴， $DD_{1}$ 为 $z$ 轴，建立空间直角坐标系，利用向量法能证明 $MN$ 平面 $C_{1}DE$ .
> >
> > (2) 求出 $\overrightarrow{DC}=(-1,\sqrt{3},0)$ ，平面 $C_{1}DE$ 的法向量 $\overrightarrow{n}=(4,0,1)$ ，利用向量法能求出点 C 到平面 $C_{1}DE$ 的距离.
> >
> > 【
> > 解答】解法一：
> >
> > 证明：（1）连结 $B_{1}C$ ，ME， $\because M$ ， $E$ 分别是 $BB_{1}$ ， $BC$ 的中点，
> >
...
> >
> > 解：（2） $C(-1, \sqrt{3}, 0)$ ， $\overrightarrow{\mathrm{DC}} = (-1, \sqrt{3}, 0)$ ，平面 $C_{1}DE$ 的法向量 $\vec{n} = (4, 0, 1)$ ，
> >
> > ∴点 C 到平面 $C_{1}DE$ 的距离：
> >
> > $$
