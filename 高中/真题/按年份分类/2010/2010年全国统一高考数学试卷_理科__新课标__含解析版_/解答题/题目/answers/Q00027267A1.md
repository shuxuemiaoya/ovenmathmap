---
answer_for: "Q00027267"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "publisher-solution"
answer_source_body_sha256: 2e6a505dcee7504778efc3c2bd0c93ec2f148dd3721bf7c7bc25727f0e94a429
---
...
> > 间直角坐标系.
> >
> > (1) 表示 $\overrightarrow{PE}$ ， $\overrightarrow{BC}$ ，计算 $\overline{PE} \cdot \overline{BC} = 0$ ，就证明 $PE \perp BC$ .
> >
> > (2) $\angle APB = \angle ADB = 60^{\circ}$ , 求出 $C, P$ 的坐标, 再求平面 $PEH$ 的法向量,
> >
> > 求向量 $\overrightarrow{\mathrm{PA}}$ ，然后求 $\overrightarrow{\mathrm{PA}}$ 与面PEH的法向量的数量积，可求直线PA与平面PEH所成
> >
> > 角的正弦值.
> >
> > 【
> > 解答】解：以 H 为原点，HA，HB，HP 分别为 x，y，z 轴，线段 HA 的长为单位长，
...
> >
> > 因此可以取 $\vec{\mathbf{n}} = (1, \sqrt{3}, 0)$ ,
> >
> > 由 $\overrightarrow{\mathrm{PA}} = (1,0, - 1)$
> >
> > 可得 $|\cos < \overrightarrow{\mathrm{PA}}, \overrightarrow{\mathrm{n}} >| = \frac{\sqrt{2}}{4}$
> >
> > 所以直线 PA 与平面 PEH 所成角的正弦值为 $\frac{\sqrt{2}}{4}$ .
> >
> > ![](../../../images/combined/4d4874f971cfa8b26fe2e0bce3d5cd9c8676af8bc9e26400a2100f6ec97a48fd.jpg)
> >
