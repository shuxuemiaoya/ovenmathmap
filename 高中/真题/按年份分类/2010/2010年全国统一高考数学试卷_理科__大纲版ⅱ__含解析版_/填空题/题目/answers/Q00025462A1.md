---
answer_for: "Q00025462"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "publisher-solution"
answer_source_body_sha256: 044f78bc62ad874764a285264301d1b39c326feac2685db9d5325c7fb5d8978f
---
...
>
> > [!note]- **【分析】**
> > （Ⅰ）由直线过点（1，3）及斜率可得直线方程，直线与双曲线交于BD两
>
> > [!note]- **【解析】**
> > 分析】（Ⅰ）由直线过点（1，3）及斜率可得直线方程，直线与双曲线交于BD两
> >
> > 点的中点为（1，3），可利用直线与双曲线消元后根据中点坐标公式找出a，b
> >
> > 的关系式即求得离心率.
> >
> > （II）利用离心率将条件 $|FA||FB|=17$ ，用含a的代数式表示，即可求得a，则A点
> >
> > 坐标可得（1，0），由于 A 在 x 轴上所以，只要证明 2AM=BD 即证得.
> >
> > 【
> > 解答】解：（Ⅰ）由题设知，Ⅰ的方程为： $y=x+2$ ，代入C的方程，并化简，
> >
...
> >
> > 解得 $a = 1$ ，或 $\mathrm{a} = -\frac{9}{5}$ （舍去），
> >
> > 故 $|\mathrm{BD}| = \sqrt{2} |\mathbf{x}_1 - \mathbf{x}_2| = \sqrt{2}\sqrt{(\mathbf{x}_1 + \mathbf{x}_2)^2 - 4\mathbf{x}_1\mathbf{x}_2} = 6,$
> >
...
> >
> > ![](../../../images/combined/8af0238e990acf02bce9c149ecc4345b8c0c3f2e3c849f0f3d96d345b599eb6d.jpg)
> >
