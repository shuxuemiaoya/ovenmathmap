...
answer_source_body_sha256: e10d26cdd50fc4e7c0a761a3123728ccb5b6c2ff3774fe757cb5adf787b6ab6a
---
...
> >
> > 由
> > (1)知椭圆方程为 $\frac{x^{2}}{2} + y^{2} = 1$ ，由于点 $A(x_{0}, y_{0})$ 满足 $\frac{x_{0}^{2}}{2} + y_{0}^{2} = 1$ ，且 $y_{0} \neq 0$ ，过 A 作 y 轴的垂线，交 y 轴于点 $B(0, y_{0})$ ，
> >
