---
answer_for: "Q00020252"
answer_provenance: authoritative
answer_source_kind: worked-example
answer_source_body_sha256: 8cb97503cd00cb95d5af677e432264e2f6089e125b4a48b5b08192054ba3d9bb
---
...
> >
> > 由（1）知平面 CEF 的一个法向量为 $\overrightarrow{DB} = (4, 2, 0)$ ,
> >
...
> >
> > 由（2）知，平面 $AEF$ 的一个法向量为 $\vec{n} = (1,1,1)$ ， $\overrightarrow{AC} = (-4,2,0)$
> >
...
>
> > [!note]- **【解析】**
> > 【答案】（1）方法一：如图，过点 E 作 $EG \parallel CC_{1}$ ，交 AD 于点 G，则有 AG = 3GD, GD = 1.
