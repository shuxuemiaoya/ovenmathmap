---
answer_for: "Q00020315"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "explicit-answer"
answer_source_body_sha256: d65d0601432ac4f3db0c9644ca04d33282c0372efce405818be3fd53d88b13ee
---
...
> > （3）根据题意结合双曲线性质可得直线斜率取值范围，设直线方程结合弦长公式可得 $\left|PQ\right|=\frac{2\left(1+n_{1}^{2}\right)}{1-n_{1}^{2}}$ $\left|MN\right|=\frac{2\left(1+n_{2}^{2}\right)}{n_{2}^{2}-1}$ ，进而分析取值范围即可得解.
>
> > [!note]- **【解析】**
> > 【小问 1 详解】
> >
