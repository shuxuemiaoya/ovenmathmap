---
answer_for: "Q00021823"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "pdf-text-recovery"
answer_source_body_sha256: 6aae015878ba40f29fe4bfb3d2c54d6bd3a34629a6c684b4f4e50275753e3bff
...
>
> > [!note]- **【分析】**
> > 已知三个圆均为半径 r=1 的等圆，圆心分别为 $C_{1}(-1,0)$ 、 $C_{2}(1,0)$ 、 $C_{3}(0,\sqrt{3})$ ，利用弦长公式 $s_{i}=2\sqrt{1-d_{i}^{2}}$ （ $d_{i}$ 为直线 l 到对应圆心的距离，且 $d_{i}<1$ 以保证直线与圆有两个交点），逐个
>
> > [!note]- **【解析】**
