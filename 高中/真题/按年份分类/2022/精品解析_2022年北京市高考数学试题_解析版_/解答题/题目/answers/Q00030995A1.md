---
answer_for: "Q00030995"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "explicit-answer"
answer_source_body_sha256: a218ad6d5b225716ab4d67d771c027df2aaa80cd2d181311e994aa4683952618
---
...
>
> > [!note]- **【分析】**
> > （1）取 $AB$ 的中点为 $K$ ，连接 $MK, NK$ ，可证平面 $MKN // \text{平面} CBB_1C_1$ ，从而可证 $MN // \text{平面} CBB_1C_1$ .
> > (2) 选①②均可证明 $BB_{1} \perp$ 平面 $ABC$ , 从而可建立如图所示的空间直角坐标系, 利用空间向量可求线面角的正弦值.
>
> > [!note]- **【解析】**
> > 【小问1详解】
> >
