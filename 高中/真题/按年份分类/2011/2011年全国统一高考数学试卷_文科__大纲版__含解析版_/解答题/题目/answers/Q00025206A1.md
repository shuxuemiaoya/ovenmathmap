---
answer_for: "Q00025206"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "publisher-solution"
answer_source_body_sha256: 3a2bfd32d716287ef14a9f4a28ffff00b2249251f493ab43ab40c61e7f6eaa56
---
...
> >
> > $\vec{\mathrm{n}}$ 与 $\overrightarrow{AB}$ 间的夹角关系即可，当 $\vec{\mathrm{n}}$ 与 $\overrightarrow{AB}$ 间的夹角为锐角时，所求的角即为它的余
> >
> > 角；当 $\vec{n}$ 与 $\overrightarrow{AB}$ 间的夹角为钝角时，所求的角为 $\langle\vec{n},\overrightarrow{AB}\rangle-\frac{\pi}{2}$
> >
> > 【
