---
answer_for: "Q00025504"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "publisher-solution"
answer_source_body_sha256: 1b1638632aa8ccb2a2c0a9bf40d20122ec0fbf00277adf31787710ce40874893
---
...
>
> > [!note]- **【分析】**
> > （Ⅰ）因为 $\angle DAB=60^{\circ}$ ，AB=2AD，由余弦定理得 $BD=\sqrt{3}AD$ ，利用勾股定理
>
> > [!note]- **【解析】**
> > 分析】（Ⅰ）因为 $\angle DAB=60^{\circ}$ ，AB=2AD，由余弦定理得 $BD=\sqrt{3}AD$ ，利用勾股定理
> >
> > 证明 BD⊥AD，根据 PD⊥底面 ABCD，易证 BD⊥PD，根据线面垂直的判定定理
> >
> > 和性质定理，可证 PA⊥BD；
> >
> > （II）建立空间直角坐标系，写出点A，B，C，P的坐标，求出向量 $\overrightarrow{AB}$ ， $\overrightarrow{PB}$ ， $\overrightarrow{BC}$ ，和
> >
> > 平面 PAB 的法向量，平面 PBC 的法向量，求出这两个向量的夹角的余弦值即
> >
> > 可.
> >
> > 【
> > 解答】（Ⅰ）证明：因为 $\angle DAB=60^{\circ}$ ， $AB=2AD$ ，由余弦定理得 $BD=\sqrt{3}AD$ ，
> >
...
> >
> > ![](../../../images/combined/64c822f98769452304069d2eedb9487f127a0a852f2da7e840abe8a668a76c86.jpg)
> >
> > 【点评】此题是个中档题. 考查线面垂直的性质定理和判定定理, 以及应用空间向
> >
> > 量求空间角问题，查了同学们观察、推理以及创造性地
> > 分析问题、解决问题能
