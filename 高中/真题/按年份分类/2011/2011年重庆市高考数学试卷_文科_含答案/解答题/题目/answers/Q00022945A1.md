...
answer_source_body_sha256: 042261d6647c8e710b136e2480d0619cb920624e1bc5b341202b4f15a0ff240e
---
...
> >
> > 取 $m = -1$ ，由（1）（2）可得， $l = \sqrt{3}$ ， $n = \frac{7\sqrt{15}}{15}$ 即 $\vec{n} = (\sqrt{3}, - 1, \frac{7\sqrt{15}}{15})$
> >
> > 显然 $\vec{k} = (0, 0, 1)$ 是平面ABC的法向量，
> >
> > 从而 $\cos<\vec{n},\quad\vec{k}>\frac{7\sqrt{109}}{109};$
> >
> > 故 $\tan <\vec{n},\vec{k}> = \frac{2\sqrt{15}}{7};$
> >
> > 则二面角 C - AB - D 的平面角的正切值为 $\frac{2\sqrt{15}}{7}$ .
> >
> > ![](../../../images/combined/b73e6ca64f8981d71134e19a68ec9f02c72c4879eee44eb36083a3318fb4b24f.jpg)
> >
