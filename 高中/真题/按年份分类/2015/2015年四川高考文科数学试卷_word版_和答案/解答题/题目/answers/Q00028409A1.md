...
>
> > [!note]- **【解析】**
> > 分析：（Ⅰ）直接标出点 F，G，H 的位置.
> >
> > $$
> > \sqrt {3}
> > $$
> >
> > （Ⅱ）先证BCHE为平行四边形，可知BE∥平面ACH，同理可证BG∥平面ACH，即可证明平面BEG2平面ACH.
> >
> > （Ⅲ）连接 FH，由 $\exists H \perp EG$ ，又 $DH \perp EG$ ， $EG \perp FH$ ，可证 $EG \perp$ 平面 BFHD，从而可证 $DF \perp EG$ ，同理 $DF \perp BG$ ，即可证明 $DF \perp$ 平面 BEG.
> >
> > 解答：解：（Ⅰ）点 F，G，H 的位置如图所示.
> >
