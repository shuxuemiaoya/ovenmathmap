---
answer_for: "Q00027153"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "publisher-solution"
answer_source_body_sha256: 11ab4a43ced51ba224bae5347561c3243670352523bbe4d375999648d2492c4e
---
...
>
> > [!note]- **【解析】**
> > 分析】(1) 如图, 过 A 作 AE⊥BC 于 E, 由已知及面积公式可得 BD=2DC, 由 AD 平分∠BAC 及正弦定理可得 $\sin\angle B=\frac{AD\times\sin\angle BAD}{BD}$ , $\sin\angle C=\frac{AD\times\sin\angle DAC}{DC}$ , 从而得解 $\frac{\sin\angle B}{\sin\angle C}$ .
> >
> > (2) 由 (1) 可求 $BD = \sqrt{2}$ . 过 D 作 $DM \perp AB$ 于 M, 作 $DN \perp AC$ 于 N, 由 AD 平分 $\angle BAC$ , 可求 $AB = 2AC$ , 令 $AC = x$ , 则 $AB = 2x$ , 利用余弦定理即可解得 BD 和 AC 的长.
> >
> > 【
...
> >
> > (2) 由 (1) 知, $\mathrm{BD} = 2\mathrm{DC} = 2 \times \frac{\sqrt{2}}{2} = \sqrt{2}$ .
> >
...
> >
> > 【点评】本题主要考查了三角形面积公式，正弦定理，余弦定理等知识的应用，属
> >
> > 于基本知识的考查.
