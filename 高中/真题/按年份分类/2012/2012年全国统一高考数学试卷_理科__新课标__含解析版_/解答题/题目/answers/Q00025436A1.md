---
answer_for: "Q00025436"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "publisher-solution"
answer_source_body_sha256: 9ee183042bd8563e1088135524406055671c615f437af3641171df9a13d95b0a
---
...
>
> > [!note]- **【解析】**
> > 分析】（1）证明 $DC_{1} \perp BC$ ，只需证明 $DC_{1} \perp$ 面 BCD，即证明 $DC_{1} \perp DC$ ， $DC_{1} \perp BD$ ;
> >
> > (2) 证明 BC⊥面 ACC₁A₁，可得 BC⊥AC 取 A₁B₁ 的中点 O，过点 O 作 OH⊥BD 于点
> >
> > H, 连接 $C_{1}O$ , $C_{1}H$ , 可得点 H 与点 D 重合且 $\angle C_{1}DO$ 是二面角 $A_{1}-BD-C_{1}$ 的平面
> >
> > 角，由此可求二面角 $A_{1}-BD-C_{1}$ 的大小.
> >
> > 【
> > 解答】（1）证明：在 Rt△DAC 中，AD=AC，∴∠ADC=45°
> >
...
> >
> > (2) 解：∵ $DC_{1} \perp BC$ ， $CC_{1} \perp BC$ ， $DC_{1} \cap CC_{1} = C_{1}$ ，∴ BC ⊥ 面 $ACC_{1}A_{1}$ ，
> >
...
> >
> > ![](../../../images/combined/6de9e521c7d859cd83e8a471eead60dbca569bc66c65c6c7f82911adc0f8be14.jpg)
> >
