...
answer_source_body_sha256: 2ad1cc63060535a52c3ff29f90e0610cce24bd7ac01abe6551a94edbf3d426ea
---
...
>
> > [!note]- **【解析】**
> > 分析】画出图形, 找出 BM 与 AN 所成角的平面角, 利用解三角形求出 BM 与 AN 所成角的余弦值.
> >
> > 【
> > 解答】解: 直三棱柱 $ABC - A_{1}B_{1}C_{1}$ 中, $\angle BCA = 90^{\circ}$ , M, N 分别是 $A_{1}B_{1}$ , $A_{1}C_{1}$ 的中点,
> >
> > 如图：BC 的中点为 O，连结 ON，
> >
