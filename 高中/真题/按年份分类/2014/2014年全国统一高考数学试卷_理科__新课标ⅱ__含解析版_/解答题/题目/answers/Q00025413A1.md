---
answer_for: "Q00025413"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "publisher-solution"
answer_source_body_sha256: d172ac4866273ee3ccd83603d1e8c81c3ad503ebd0e5dfd6681bed7a38818b18
---
...
>
> > [!note]- **【分析】**
> > (1) 根据条件求出 M 的坐标, 利用直线 MN 的斜率为 $\frac{3}{4}$ , 建立关于 a, c 的
>
> > [!note]- **【解析】**
> > 分析】(1) 根据条件求出 M 的坐标, 利用直线 MN 的斜率为 $\frac{3}{4}$ , 建立关于 a, c 的
> >
> > 方程即可求 C 的离心率；
> >
> > (2) 根据直线 MN 在 y 轴上的截距为 2，以及 $\left|MN\right|=5\left|F_{1}N\right|$ ，建立方程组关系，求
> >
> > 出 N 的坐标，代入椭圆方程即可得到结论.
> >
> > 【
...
> >
> > 即 $\tan \angle MF_{1}F_{2} = \frac{b^{2}}{\frac{a}{2c}} = \frac{b^{2}}{2ac} = \frac{3}{4}$
> >
...
> > 解得 a=7， $b=2\sqrt{7}$ .
> >
> > ![](../../../images/combined/60915f30663570070bd781ea3c7c37d118499df2c0ea8dfd0723a165d08e432c.jpg)
> >
