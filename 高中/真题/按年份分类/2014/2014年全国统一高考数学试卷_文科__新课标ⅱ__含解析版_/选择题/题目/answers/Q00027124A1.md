...
> >
> > 【
> > 解答】解：由题意画出图形如图：点 $M(x_{0},1)$ ，要使圆 $O: x^{2}+y^{2}=1$ 上存在点 N，使
> >
> > 得 $\angle OMN=45^{\circ}$ ,
> >
