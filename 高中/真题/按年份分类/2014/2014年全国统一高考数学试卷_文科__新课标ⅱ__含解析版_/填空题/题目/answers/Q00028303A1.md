---
answer_for: "Q00028303"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "explicit-answer"
answer_source_body_sha256: cf088de2de26e67bda4576e782b999b2cc3983227a1887aa92052974760c40de
---

> [!faq]- 2014年全国统一高考数学试卷（文科）（新课标ⅱ）（含解析版）解析
>
> > [!success]- **【答案】** （12分）设 $F_{1}, F_{2}$ 分别是C: $\frac{x^{2}}{a^{2}}+\frac{y^{2}}{b^{2}}=1(a>b>0)$ 的左，右焦点，M是C上一点
>
> > [!note]- **【分析】**
> > （1）根据条件求出 M 的坐标，利用直线 MN 的斜率为 $\frac{3}{4}$ ，建立关于 a, c 的
>
> > [!note]- **【解析】**
> > 解：（1）∵M是C上一点且 $MF_{2}$ 与x轴垂直，
> >
