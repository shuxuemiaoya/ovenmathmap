...
>
> > [!note]- **【解析】**
> > 分析】由 E 为 AB 的中点, 可取 AD 中点 F, 连接 EF, 则 $\angle CEF$ 为异面直线 CE 与 BD 所成角, 设出正四面体的棱长, 求出 $\triangle CEF$ 的三边长, 然后利用余弦定理求解异面直线 CE 与 BD 所成角的余弦值.
> >
> > 【
> > 解答】解：如图，
> >
