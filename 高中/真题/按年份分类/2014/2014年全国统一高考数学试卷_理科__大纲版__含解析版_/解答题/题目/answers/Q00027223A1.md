---
answer_for: "Q00027223"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "publisher-solution"
answer_source_body_sha256: 11bc0c173a7735f97f55aac64063b38f45b611301c388d3e653f7bfcb7c6f7e6
---
...
> >
> > （II）作辅助线可证 $\angle A_{1}FD$ 为二面角 $A_{1} - AB - C$ 的平面角，解三角形由反三角函
> >
> > 数可得.
> >
> > 【
> > 解答】解：（Ⅰ）∵ $A_{1}D$ ⊥平面ABC， $A_{1}DC$ 平面 $AA_{1}C_{1}C$ ，
> >
...
> >
> > (II) $\because BC \perp$ 平面 $AA_{1}C_{1}C$ , $BCC$ 平面 $BCC_{1}B_{1}$ ,
> >
> > ∴平面 $AA_{1}C_{1}C \perp$ 平面 $BCC_{1}B_{1}$ ,
> >
> > 作 $A_{1}E \perp CC_{1}$ ，E 为垂足，可得 $A_{1}E \perp$ 平面 $BCC_{1}B_{1}$ ，
> >
> > 又直线 $AA_{1}$ 平面 $BCC_{1}B_{1}$ ,
> >
> > $\therefore A_{1}E$ 为直线 $AA_{1}$ 与平面 $BCC_{1}B_{1}$ 的距离，即 $A_{1}E = \sqrt{3}$ ，
> >
> > ∵ $A_{1}C$ 为∠ACC $_{1}$ 的平分线，∴ $A_{1}D=A_{1}E=\sqrt{3}$ ,
> >
...
> >
> > 由 $AD=\sqrt{AA_{1}^{2}-A_{1}D^{2}}=1$ 可知 D 为 AC 中点，
> >
> > $$
...
> >
> > $$
> > \therefore \tan \angle A _ {1} F D = \frac {A _ {1} D}{D F} = \sqrt {1 5},
> > $$
> >
> > ∴二面角 $A_{1}-AB-C$ 的大小为 $\arctan\sqrt{15}$
> >
> > ![](../../../images/combined/11827ac288a37c7d9a5ef072c66b38597603b30b0d2149156e4335beb56d37c1.jpg)
> >
