...
>
> > [!note]- **【解析】**
> > 分析】利用向量加法的三角形法则，将 $\overrightarrow{EB}$ ， $\overrightarrow{FC}$ 分解为 $\overrightarrow{EF} + \overrightarrow{FB}$ 和 $\overrightarrow{FE} + \overrightarrow{EC}$ 的形式，进
> >
> > 而根据D，E，F分别为 $\triangle ABC$ 的三边BC，CA，AB的中点，结合数乘向量及向量
> >
> > 加法的平行四边形法则得到
> > 答案.
> >
