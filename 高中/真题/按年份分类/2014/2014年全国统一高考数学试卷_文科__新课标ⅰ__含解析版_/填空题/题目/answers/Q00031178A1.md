---
answer_for: "Q00031178"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "explicit-answer"
answer_source_body_sha256: 23898838d37fcf51cf21d171921b8e8d1aea81b708c6186ee66dc866b6ec9462
---

> [!faq]- 2014年全国统一高考数学试卷（文科）（新课标ⅰ）（含解析版）解析
>
> > [!success]- **【答案】** (12 分) 如图, 三棱柱 $ABC - A_{1}B_{1}C_{1}$ 中, 侧面 $BB_{1}C_{1}C$ 为菱形, $B_{1}C$ 的中点为 $O$ , 且
>
> > [!note]- **【分析】**
> > （1）连接 $BC_{1}$ ，则 O 为 $B_{1}C$ 与 $BC_{1}$ 的交点，证明 $B_{1}C \perp$ 平面 ABO，可得
>
> > [!note]- **【解析】**
> > （1）证明：连接 $\mathrm{BC}_{1}$ ，则 O 为 $\mathrm{B}_{1} \mathrm{C}$ 与 $\mathrm{BC}_{1}$ 的交点，
> >
> > ∵侧面 $BB_{1}C_{1}C$ 为菱形，
> >
