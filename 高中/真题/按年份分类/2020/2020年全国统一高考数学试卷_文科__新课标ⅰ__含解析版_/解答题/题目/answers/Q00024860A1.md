---
answer_for: "Q00024860"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "publisher-solution"
answer_source_body_sha256: d423428b3102808857ab4c5c017ba9d4d0b1e2eaf7a8731f2b905de7e9441918
---
...
>
> > [!note]- **【解析】**
> > 分析】(1) 根据题意, $B = 150^{\circ}$ , 通过余弦定理, 即可求得 $c = 2, a = 2\sqrt{3}$ , 进而通过三角形面积公式 $S_{\triangle ABC} = \frac{1}{2} a c \sin B = \frac{1}{2} \cdot 2\sqrt{3} \cdot 2 \cdot \frac{1}{2} = \sqrt{3}$ .
> >
> > (2) 通过三角形三边和为 $180^{\circ}$ , 将 $A = 180^{\circ} - 150^{\circ} - C$ 代入 $\sin A + \sqrt{3} \sin C = \frac{\sqrt{2}}{2}$ , 根据 $C$ 的范围, 即可求得 $C = 15^{\circ}$ .
> >
> > 【
> > 解答】解：（1） $\triangle ABC$ 中， $B=150^{\circ}$ ， $a=\sqrt{3}c$ ， $b=2\sqrt{7}$ ，
> >
> > $$
