---
answer_for: "Q00027697"
answer_provenance: authoritative
answer_source_kind: embedded-exam-solution
answer_value_source: "explicit-answer"
answer_source_body_sha256: 373c6c71b139989634eb9acd2ee0ccba2a1c3fbdfa4826b37d5d695ab14fe6e4
---
...
> > (2) 由椭圆方程 $\frac{x^2}{a^2} + \frac{y^2}{b^2} = 1$ ，得 $\frac{11^2}{a^2} + \frac{4.5^2}{b^2} = 1$ .
> >
> > $$
> > \frac {1 1 ^ {2}}{a ^ {2}} + \frac {4 . 5 ^ {2}}{b ^ {2}} \geq \frac {2 \times 1 1 \times 4 . 5}{a b}
> > $$
> >
> > ![](../../../images/combined/69430278b2e9d1421a5f344ca689b4e4e9a1a1e596799901ddb4a35720049d44.jpg)
> >
> > $$
> > a b \geq 9 9
> > $$
