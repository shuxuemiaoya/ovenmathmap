...
> >
> > 【
> > 解答】解：由题意可知：A（-a，0）， $F_{1}$ （-c，0）， $F_{2}$ （c，0），直线AP的方程为： $y=\frac{\sqrt{3}}{6}(x+a)$ ，
