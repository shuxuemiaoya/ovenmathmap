...
>
> > [!note]- **【解析】**
> > 分析】（I）先证明 BF⊥AC，再证明 BF⊥CK，进而得到 BF⊥平面 ACFD.
> >
> > (II) 方法一：先找二面角 B-AD-F 的平面角，再在 Rt△BQF 中计算，即可得出；方法二：通过建立空间直角坐标系，分别计算平面 ACK 与平面 ABK 的法向量，进而可得二面角 B-AD-F 的平面角的余弦值.
> >
> > 【
> > 解答】（I）证明：延长AD，BE，CF相交于点K，如图所示，∵平面BCFE⊥平面ABC， $\angle ACB=90^{\circ}$ ，
> >
> > ∴AC⊥平面 BCK，∴BF⊥AC.
> >
