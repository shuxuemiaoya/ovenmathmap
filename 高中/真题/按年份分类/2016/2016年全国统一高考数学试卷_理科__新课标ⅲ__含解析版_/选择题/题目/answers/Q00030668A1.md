...
>
> > [!note]- **【分析】**
> > 作出图形，令 $\angle DAC = \theta$ ，依题意，可求得 $\cos \theta = \frac{AD}{AC} = \frac{\frac{a}{3}}{\sqrt{\left(\frac{1}{3}a\right)^2\left(\frac{2a}{3}\right)^2}} = \frac{\sqrt{5}}{5}$ $，\sin \theta = \frac{2\sqrt{5}}{5}$ ，利用两角和的余弦即可求得答案.
>
> > [!note]- **【解析】**
