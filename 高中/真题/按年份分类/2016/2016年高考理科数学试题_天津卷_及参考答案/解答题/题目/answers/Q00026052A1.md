...
answer_source_body_sha256: 99a0dd82bb79df17c916b4931dca275f1749f754296a44b1ee8e4c12fb84fb26
---
...
>
> > [!note]- **【解析】**
> > 分析】（1）由题意画出图形，把 |OF|、|OA|、|FA| 代入 $\frac{1}{|OF|} + \frac{1}{|OA|} = \frac{3e}{|FA|}$ ，转化为关于 a 的方程，解方程求得 a 值，则椭圆方程可求；
> >
...
> >
> > 【
> > 解答】解：（1）由 $\frac{1}{|OF|}+\frac{x^{2}}{4}=\frac{3e}{|FA|}$ ，得 $\frac{1}{\sqrt{a^{2}-3}}+\frac{1}{a}=\frac{3\cdot\frac{\sqrt{a^{2}-3}}{a}}{a-\sqrt{a^{2}-3}}$ 即 $\frac{a+\sqrt{a^{2}-3}}{a\cdot\sqrt{a^{2}-3}}=\frac{3\sqrt{a^{2}-3}}{a(a-\sqrt{a^{2}-3})}$ ∴ $a[a^{2}-(a^{2}-3)]=3a(a^{2}-3)$ ，解得a=2.
