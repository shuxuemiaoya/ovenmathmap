...
>
> > [!success]- **【答案】** $\frac{3}{2} b - \frac{1}{2} a\quad \frac{\pi}{6}$
>
> > [!note]- **【分析】**
> > 法一：根据向量的减法以及向量的数乘即可表示出 $\overline{DE}$ ，以 $\left\{a,b\right\}$ 为基底，表示出 $\overline{AB},\overline{DE}$ ，由 $AB\perp DE$ 可得 $3b^{2}+a^{2}=4b\cdot a$ ，再根据向量夹角公式以及基本不等式即可求出。
> >
