---
answer_for: "Q00035880"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 1c653d09075d1117f9eccc40f35721206f2365bc9c21d6a60209ebe0345989ac
---
...
>
> > [!note]- **【分析】**
> > 【分析】（Ⅰ）先由已知易得 $PE \perp AC$ ，再注意平面 $PAC \perp$ 平面ABC，且交线为AC，由面面垂直的性质可得 $PE \perp$ 平面ABC，再由线面垂直的性质可得到 $AB \perp PE$ ，再注意到 $EF // BC$ ，而 $BC \perp AB$ ，从而有 $AB \perp EF$ ，那么由线面垂的判定定理可得 $AB \perp$ 平面PFE，
> >
> > (Ⅱ) 设 BC=x 则可用 x 将四棱锥 P-DFBC 的体积表示出来，由已知其体积等于 $^{7}$ ，从而得到关于 x 的一个一元方程，解此方程，再注意到 x>0 即可得到 BC 的长．
>
> > [!note]- **【解析】**
> > 【详解】证明：如题（20）图·由 $DE = EC, PD = PC$ 知， $E$ 为等腰 $\Delta PDC$ 中 $DC$ 边的中点，故 $PE \perp AC$ ，
> > ![](../../../images/questions/part-002/09e0ce2366a13a06cd6384050be24409452920eba208079ef988312d0bd5bf2a.jpg)
...
> > $$
> > \mathrm{AD} = \frac {1}{2} A E, \mathrm{S} _ {\triangle A F B} = \frac {1}{2} \mathrm{S} _ {\triangle A F E} = \frac {1}{2} \cdot \frac {4}{9} \mathrm{S} _ {\triangle A B C} = \frac {2}{9} \mathrm{S} _ {\triangle A B C} = \frac {1}{9} x \sqrt {3 6 - x ^ {2}},
> > $$
