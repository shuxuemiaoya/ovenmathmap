---
answer_for: "Q00055409"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 9bbb65f10e7424e54dca624ee77e659c5c05b46ab1d53315b401e044d54059ed
---
...
> >
> > 由
> > （1）可得 $EB_{1} \perp BE$ 。所以 $EB_{1}^{2} + BE^{2} = BB_{1}^{2}$ ，即 $2BE^{2} = BB_{1}^{2}$
> >
...
> >
> > 【整体点评】
> > (2)方法一：利用体积公式计算体积需要同时计算底面积和高，是计算体积的传统方法；方法二：利用不同几何体之间的比例关系计算体积是一种方便有效快速的计算体积的方法，核心思想为等价转化·
