---
answer_for: "Q00055424"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 022a87e66b1814591f4647053444d4b0d529634ee6849c3d989240ddec45563e
---
...
> >
> > 【详解】试题分析：
> > （1）由 $\angle BAP = \angle CDP = 90^{\circ}$ ，得 $AB \perp AP$ ， $CD \perp PD$ 。从而得 $AB \perp PD$ ，进而而 $AB \perp$ 平面 PAD，由面面垂直的判定定理可得平面 $PAB \perp$ 平面 PAD；
> > （2）设 PA = PD = AB = DC = a，取 AD 中点 O，连结 PO，则 $PO \perp$ 底面 ABCD，且 $AD = \sqrt{2}a, PO = \frac{\sqrt{2}}{2}a$ ，由四棱锥 P - ABCD 的体积为 $\frac{8}{3}$ ，求出 a = 2，由此能求出该四棱锥的侧面积。
> >
> > 试题解析：
...
> >
> > 由
> > （1）知， $AB \perp$ 面 PAD ，故 $AB \perp PE$ ，可得 $PE \perp$ 平面 ABCD
> >
