---
answer_for: "Q00055415"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: c1ed0f8ad1d9e1835ba39db8e35cb929c2293196e9b30f6444632647e249a7fe
---
...
> > (1)$ 知 PO 即为 P 到平面 COM 的距离，且 $PO \perp OM$ ．又 $PO = 2\sqrt{3}$ ，在 $\triangle OMC$ 中， $OC = 2, CM = \frac{2}{3} BC = \frac{4\sqrt{2}}{3}, \angle ACB = 45^{\circ}$ ，则由余弦定理得 $OM = \frac{2\sqrt{5}}{3}$ ，
...
> >
> > 【整体点评】
> > （2）方法一：根据定义法求点到面的距离，是解决点面距问题的首选方法，特别是题目中
> >
