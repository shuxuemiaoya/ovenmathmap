---
answer_for: "Q00055419"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 25659d5033385f792655e3fa94632b204e38946c0fe15c28444e2be2c89cba78
---
> [!faq]- 《zhenti-专题21 立体几何大题综合》例题解析
>
> > [!success]- **【答案】** (I)证明见解析；(II) $\frac{\sqrt{13}}{26}$ ；(III) $\frac{\sqrt{3}}{4}$
>
> > [!note]- **【解析】**
...
> >
> > 详解：
> > （1）证明：由平面 $ABC^{\perp}$ 平面ABD，平面 $ABC^{\cap}$ 平面 $ABD=AB, AD^{\perp}AB$ ，可得 $AD^{\perp}$ 平面ABC，故 $AD^{\perp}BC$ 。
> >
> > (Ⅱ) 取棱 AC 的中点 N，连接 MN，ND．又因为 M 为棱 AB 的中点，故 $MN^{\parallel}BC$ ．所以 $\angle DMN$ （或其补角）为异面直线 BC 与 MD 所成的角．
> >
> > ![](../../../images/questions/part-001/37769054ec17e6209765734151fc926b48f5b6af08a1e1732cc52ca0c470a281.jpg)
> >
...
> > 在 Rt△CAD 中， $CD=\sqrt{AC^{2}+AD^{2}}=4$ 在 Rt△CMD 中， $\sin\angle CDM=\frac{CM}{CD}=\frac{\sqrt{3}}{4}$
> >
> > 所以，直线 $CD$ 与平面ABD所成角的正弦值为 $\frac{\sqrt{3}}{4}$
> >
