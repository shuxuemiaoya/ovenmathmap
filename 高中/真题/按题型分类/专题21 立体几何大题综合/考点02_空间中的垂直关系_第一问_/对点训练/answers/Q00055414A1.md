---
answer_for: "Q00055414"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 0ca21ab5fc770205f9cf3d2d164fc11e502f659de276382ebf3126db2c85272e
---
> [!faq]- 《zhenti-专题21 立体几何大题综合》例题解析
>
> > [!success]- **【答案】** （Ⅰ）证明见解析；（Ⅱ） $\frac{\sqrt{39}}{13}$
>
> > [!note]- **【分析】**
...
> >
> > ![](../../../images/questions/part-001/0458c2594fd68a8bb8d5a6a885477f77d8a96f03b9b1a95142260c9da23ac726.jpg)
> >
> > 由题意知各点坐标如下：
> >
> > $$
...
> >
> > ![](../../../images/questions/part-001/b85cc17c32377e344e7a405c40294a171d5235fbece6e9fdf269bccbfb9db6e5.jpg)
> >
...
> >
> > 所以 $C_{1}D=\sqrt{3}$ ，故 $\sin\angle C_{1}AD=\frac{C_{1}D}{AC_{1}}=\frac{\sqrt{39}}{13}$ .
> >
...
> >
> > 由 $^{
> > (1)}$ 可知 $AC_{1}=(0,2\sqrt{3},1)$ , $AB=(1,\sqrt{3},0)$ , $BB_{1}=(0,0,2)$ ,
> >
> > 设平面 $ABB_{1}$ 的法向量 $n=(x,y,z)$ .
> >
> > 由 $\left\{\begin{aligned}n\cdot AB&=0\\ \rightarrow\square\square\square\end{aligned}\right.$ 即 $\left\{\begin{aligned}x+\sqrt{3}y&=0\\ 2z&=0\end{aligned}\right.$ ，可取 $n=(-\sqrt{3},1,0)$ ，
> >
...
> >
> > ![](../../../images/questions/part-001/760ef61cb0ac1e2fd9355a5a25ccc3199668eb01813ee44438e35eb8953babc9.jpg)  
> > 图2
> >
...
> >
> > ![](../../../images/questions/part-001/0ff4ab6b63ce1e54d1a33e57163146067de5cc768ebab4b93ca259038f0746f8.jpg)  
> > 图3
> >
...
> > [方法八]：定义法+等积法
> >
> > 如图 $^{4}$ ，延长 $A_{1}B_{1}, AB$ 交于点E，易知BE=2，又AB=BC=2，所以 $AC\perp CE$ ，故 $CE\perp$ 面 $AA_{1}C_{1}C$ 。设点 $C_{1}$ 到平面 $ABB_{1}$ 的距离为h，由 $V_{E-AA_{1}C_{1}}=V_{C_{1}-AA_{1}E}$ 得 $\frac{1}{3}\times\frac{1}{2}AA_{1}\cdot AE\cdot h=\frac{1}{3}\times\frac{1}{2}AA_{1}\cdot AC\cdot CE$ ，解得 $h=\sqrt{3}$ 。
> >
> > ![](../../../images/questions/part-001/fa82ac501569a59f945fbb9744c2fcd323f9e965bcbe7f602a9e0fca07927557.jpg)  
> > 图4
> >
