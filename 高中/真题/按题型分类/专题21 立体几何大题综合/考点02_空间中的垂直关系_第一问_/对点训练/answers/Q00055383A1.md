---
answer_for: "Q00055383"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 5521fa6e097eaf6240c5238576050bac1190d6d01d9f0cf1691cd71209f4466c
---
...
>
> > [!note]- **【分析】**
> > （1）由题意，根据余弦定理求得 $EF = 2$ ，利用勾股定理的逆定理可证得 $EF \perp AD$ ，则 $EF \perp PE, EF \perp DE$ ，结合线面垂直的判定定理与性质即可证明；
> >
> > （2）由
> > （1），根据线面垂直的判定定理与性质可证明 $PE \perp ED$ ，建立如图空间直角坐标系 $E - xyz$ ，利用空间向量法求解面面角即可·
>
> > [!note]- **【解析】**
> > （1）由 $AB = 8, AD = 5\sqrt{3}, AE = \frac{2}{5} AD, AF = \frac{1}{2} AB$
> >
...
> >
> > 所以 $PE \perp EC$ ，由
> > （1）知 $PE \perp EF$ ，又 $EC \cap EF = E, EC, EF \subset$ 平面 $ABCD$
> >
...
> >
> > 所以 $n = (0,2,3),\stackrel {\sqcup}{m} = (\sqrt{3}, - 1,1)$
> >
...
> >
> > ![](../../../images/questions/part-001/ec96d5fcde7cd0607324190fb1e79e1bb399bcdd1fb8f0c9d8d7838bb5c5f926.jpg)
