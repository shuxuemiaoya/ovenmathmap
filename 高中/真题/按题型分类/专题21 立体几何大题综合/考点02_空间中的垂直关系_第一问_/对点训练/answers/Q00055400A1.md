---
answer_for: "Q00055400"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: edb709f2c24e5fa7ec0cbe94acc5a05c10a3f6af9a1218bf323d3438711bb721
---
...
>
> > [!note]- **【分析】**
> > （1）要证明 $PA \perp$ 平面 PBC，只需证明 $PA \perp PB$ ， $PA \perp PC$ 即可；
> >
> > (2) 方法一：过 O 作 ON ∥ BC 交 AB 于点 N，以 O 为坐标原点，OA 为 x 轴，ON 为 y 轴建立如图所示的空间直角坐标系，分别算出平面 PCB 的一个法向量 n，平面 PCE 的一个法向量为 m，利用公式
> >
...
> >
> > ![](../../../images/questions/part-001/7a6f2320e07c3bfeaa1d659273bcc2631d94d29820fd2f2d76e523d13f76471a.jpg)
> >
...
> >
> > ![](../../../images/questions/part-001/eeb2157cc55e772bd7928914ee584a8a615a23d775c04d398759b479dfa85216.jpg)
> >
> > [方法四]：空间基底向量法
> >
> > 如图所示，圆锥底面圆 $O$ 半径为 $R$ ，连结 $DE$ ， $AE = AD = DE$ ，易得 $OD = \sqrt{3} R$
> >
> > ![](../../../images/questions/part-001/7e0bb4d59cfc9e77a047a2a9116b5f0f4b40909b67e1ba77944139d09cf25686.jpg)
> >
...
> > (2) [方法一]: 空间直角坐标系法
> >
> > 过 O 作 ON ∥ BC 交 AB 于点 N，因为 PO ⊥ 平面 ABC，以 O 为坐标原点，OA 为 x 轴，ON 为 y 轴建立如图所示的空间直角坐标系，
> >
> > ![](../../../images/questions/part-001/28e507f54307805bf878175ba9a769baab788b3b49ad25be6fb9d8fa15044df4.jpg)
> >
...
> > [方法二]【最优解】：几何法
> >
> > 设 $BC \cap AE = F$ ，易知 $F$ 是 $BC$ 的中点，过 $F$ 作 $FG\| AP$ 交 $PE$ 于 $G$ ，取 $PC$ 的中点 $H$
> >
> > 联结 GH ，则 HF ∥ PB .
> >
...
> >
> > 由
> > （1）可得， $BC^{2} = PB^{2} + PC^{2}$ ，得 $PB\bot PC$
> >
...
> >
> > ![](../../../images/questions/part-001/468f321d7ead765a8892866b51038570ff4fdcba8d840b6c724b1da4dad7d1e1.jpg)
> >
> > [方法三]：射影面积法
> >
...
> >
> > 由
> > （1）知 $NE = \frac{1}{4} AE$ ，所以 $NH \parallel PA$ 。故 $NH \perp$ 平面 PBC。
> >
...
> > 所以二面角 $B - PC - E$ 的余弦值为 $\frac{2\sqrt{5}}{5}$
> >
> > ![](../../../images/questions/part-001/b1e867affb7edb8ccdfcd902ed957ad98084588110cff906e03018ce8c6de410.jpg)
> >
> > 【整体点评】本题以圆锥为载体，隐含条件是圆锥的轴垂直于底面，
> > （1）方法一：利用勾股数进行运算证明，是在给出数据去证明垂直时的常用方法；方法二：选择建系利用空间向量法，给空间立体感较弱的学生提供了可行的途径；方法三：利用线面垂直，结合勾股定理可证出；方法四：利用空间基底解决问题此解法在解答题中用的比较少；
> >
