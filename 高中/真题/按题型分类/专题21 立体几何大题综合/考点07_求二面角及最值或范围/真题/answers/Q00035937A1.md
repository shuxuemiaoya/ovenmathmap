---
answer_for: "Q00035937"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 560918f150c6f5ca0861c2a68117f44a9b1f709454f4e4d06d11cc62371acebe
---
...
>
> > [!note]- **【解析】**
> > 【详解】（1）证明：在直三棱柱 $ABC-A_{1}B_{1}C_{1}$ 中， $AA_{1}\perp$ 平面 $A_{1}B_{1}C_{1}$ ，且 $AC\perp AB$ ，则 $A_{1}C_{1}\perp A_{1}B_{1}$
> > 以点 $A_{1}$ 为坐标原点， $A_{1}A$ 、 $A_{1}B_{1}$ 、 $A_{1}C_{1}$ 所在直线分别为 $x$ 、 $y$ 、 $z$ 轴建立如下图所示的空间直角坐标系，
> > ![](../../../images/questions/part-002/bdcbd4ea7c3d2a3a8e383ce3d223d0c7464b0162fc7ba3c2b88e28924a46338f.jpg)
...
> > 设平面 $A_{1}CD$ 的法向量为 $v = (x_{2},y_{2},z_{2})$ ，则 $\left\{ \begin{array}{l} - A_{1}C = 2x_{2} + 2z_{2} = 0 \\ v \cdot A_{1}D = y_{2} = 0 \end{array} \right.$
