---
answer_for: "Q00035950"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: ab99d59caeb5a915d8b9d01689eea301a32178f75324b0d48760d424ed4f1d19
---
...
>
> > [!note]- **【分析】**
> > 【分析】（1）方法一：先证 $BC \perp$ 平面 $CMD$ ，得 $BC \perp DM$ ，再证 $CM \perp DM$ ，由线面垂直的判定定理可得 $DM \perp$ 平面 $BMC$ ，即可根据面面垂直的判定定理证出；
> >
...
> > [方法二]：判定定理
> > 由题设知·平面 $CMD^{\perp}$ 平面 ABCD，交线为 CD·因为 $AD \perp CD$ ， $AD \subset$ 平面 ABCD，所以 $AD \perp$ 平面 MCD，而 $CM \subset$ 平面 MCD，所以 $AD \perp CM$ ，因为 M 为 CD 上异于 C，D 的点·且 DC 为直径，所以 $DM^{\perp}CM$ ·又 $AD \cap DM = D$ ，所以， $CM \perp$ 平面 AMD，而 $CM \subset$ 平面 BMC，所以平面 AMD ⊥ 平面 BMC。
> > [方法三]：向量法
> > 建立直角坐标系，如图 $^{2}$ ，设 $M(0,a,b)$ ， $D(0,0,0)$ ， $A(2,0,0)$ ， $B(2,2,0)$ ， $C(0,2,0)$ ，
> > 所以 $DA = (2, 0, 0)$ , $DM = (0, a, b)$
...
> > 同理可得，平面 $BMC$ 的一个法向量 $n = (0, b, 2 - a)$ ，因为点 $M$ 在以 $\left(0, 1, 0\right)$ 为圆心，半径为1的圆上，所以， $\left(a - 1\right)^2 + b^2 = 1$ ，即 $a^2 + b^2 - 2a = 0$ ，而 $\stackrel{\sqcup}{m} \cdot n = a^2 + b^2 - 2a = 0$ ，所以平面 $AMD \perp$ 平面 $BMC$ 。
> > ![](../../../images/questions/part-003/951a8a87a8d6a4d0394b62212f7078cfdc52eaed7075691b316239aba312bf95.jpg)
> > 图2
> > (2) [方法一]：【通性通法】向量法
> > 以 D 为坐标原点，DA 的方向为 x 轴正方向，建立如图所示的空间直角坐标系 $D^{-xyz}$
> > ![](../../../images/questions/part-003/f9bf49f76448e5fc6ddc81b40e1368c7556b0b80b5f75cc5ffa63de19aca526d.jpg)
...
> > 是平面 MCD 的一个法向量, 因此 $\cos\langle n, DA\rangle = \frac{n \cdot DA}{|n||DA|} = \frac{\sqrt{5}}{5}$ ， $\sin\langle n, DA\rangle = \frac{2\sqrt{5}}{5}$
...
> > ![](../../../images/questions/part-003/92775c09067e69717be81cf16b63108232c428d1d6fdca6902f0cc0c140b4020.jpg)
> > 图3
> > [方法三]：【最优解】面积射影法
...
> > ![](../../../images/questions/part-003/5b089b66959a4583dee9a1f04684d943bf4b4601666111b750e2f998169a4271.jpg)
> > 图4
