---
answer_for: "Q00035939"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: d5be807178c88027c7f3d073d062fb53c40c49efd7151444fb42ca7aac982bd9
---
...
> > ![](../../../images/questions/part-002/07935c1fb1c818e95b97a1bbaa282babd5a4175aad3326c37cf21ff89694ebc1.jpg)
...
> > $\because A_{1}B_{1}//AB, BF \perp A_{1}B_{1}, \therefore BF \perp AB, \text{又} BB_{1} \cap BF = B, \therefore AB \perp \text{平面} BCC_{1}B_{1}$ . 所以 $BA, BC, BB_{1}$ 两两垂直.
> > 以 $B$ 为坐标原点，分别以 $BA, BC, BB_{1}$ 所在直线为 $x, y, z$ 轴建立空间直角坐标系，如图.
> > ![](../../../images/questions/part-002/ae743a9f825032adf01e04cf5cb28211b79aead4a357e5c81008e684a674fdd8.jpg)
> > $$
...
> > 因为 $\overline{BF} = (0, 2, 1)$ , $\overline{DE} = (1 - a, 1, -2)$
> > 所以 $BF \cdot DE = 0 \times (1 - a) + 2 \times 1 + 1 \times (-2) = 0$ ，所以 $BF \perp DE$
> > [方法三]：因为 $BF \perp A_{1}B_{1}$ ， $A_{1}B_{1}//AB$ ，所以 $BF \perp AB$ ，故 $BF \cdot A_{1}B_{1} = 0$ ， $BF \cdot AB = 0$ ，所以
> > $$
> > \stackrel {{\text {UU}}} {{B F}} \cdot \stackrel {{\text {UU}}} {{E D}} = \stackrel {{\text {UU}}} {{B F}} \cdot \left(\stackrel {{\text {UU}}} {{E B}} + \stackrel {{\text {UU}}} {{B B _ {1}}} + \stackrel {{\text {UU}}} {{B _ {1} D}}\right) \stackrel {{\text {UU}}} {{=}} B F \cdot \stackrel {{\text {UU}}} {{B _ {1} D}} + \stackrel {{\text {UU}}} {{B F}} \cdot \left(\stackrel {{\text {UU}}} {{E B}} + \stackrel {{\text {UU}}} {{B B _ {1}}}\right) = \stackrel {{\text {UU}}} {{B F}} \cdot \stackrel {{\text {UU}}} {{E B}} + \stackrel {{\text {UU}}} {{B F}} \cdot \stackrel {{\text {UU}}} {{B B _ {1}}}
> > $$
> > $$
...
> > 所以  \( \left\{\begin{aligned}&m\cdot\stackrel{\square\square}{E}F=0\\&m\cdot DE=0\end{aligned}\right. \) ，即  \( \left\{\begin{aligned}-x+y+z=0\\(1-a)x+y-2z=0\end{aligned}\right. \)
> > 令 $z = 2 - a$ ，则 $m = (3,1 + a,2 - a)$
> > 因为平面 $BCC_{1}B_{1}$ 的法向量为 $\overline{BA} = (2,0,0)$
> > 设平面 $BCC_{1}B_{1}$ 与平面 DEF 的二面角的平面角为 $\theta$
> > $$
> > \left| \cos \theta \right| = \frac {\left| m \cdot B A \right|}{\left| m \right| \cdot \left| B A \right|} = \frac {6}{2 \times \sqrt {2 a ^ {2} - 2 a + 1 4}} = \frac {3}{\sqrt {2 a ^ {2} - 2 a + 1 4}}
> > $$
...
> > ![](../../../images/questions/part-002/7c8ac7c0e1ebe837f9672777670fb0abcc7e60051caac5f61717e66e78832744.jpg)
...
> > 所以 $DH = \sqrt{B_1H^2 + B_1D^2} = \sqrt{\frac{s^2}{1 + (2 - s)^2} + t^2} = \sqrt{\frac{9t^2}{2t^2 - 2t + 5} + t^2}$ 则 $\sin\angle DHB_{1}=\frac{B_{1}D}{DH}=\frac{t}{\sqrt{\frac{9t^{2}}{2t^{2}-2t+5}+t^{2}}}=\frac{1}{\sqrt{\frac{9}{2\left(t-\frac{1}{2}\right)^{2}+\frac{9}{2}}}+1}$
> > ![](../../../images/questions/part-002/d5cfd8977088cc922a74fcd9a0041da150e742a40a555ff076bc9d2d6175ad13.jpg)
...
> > 在 $\mathrm{Rt}\triangle ECF$ 中， $EF = \sqrt{EC^2 + FC^2} = \sqrt{3}$ ，过 $D$ 作 $B_{1}N$ 的平行线交 $EN$ 于点 $Q$ ：
> > 在 $\mathrm{Rt}^{\triangle}$ DEQ中， $DE = \sqrt{QD^2 + EQ^2} = \sqrt{5 + (1 - t)^2}$
> > 在 $\triangle DEF$ 中，由余弦定理得 $\cos \angle DFE = \frac{DF^2 + EF^2 - DE^2}{2DF\cdot EF} = \frac{\sqrt{3t^2 + 15}(t + 1)}{3(t^2 + 5)}$ ， $\sin \angle DFE = \sqrt{\frac{2t^2 - 2t + 14}{3(t^2 + 5)}}$
> > $S_{\triangle DFE} = \frac{1}{2} DF\cdot EF\sin \angle DFE = \frac{1}{2}\sqrt{2t^2 - 2t + 14}, S_{\triangle B_1NF} = \frac{3}{2},$
> > $\cos \theta = \frac{S_{\triangle B_1NF}}{S_{\triangle DFE}} = \frac{3}{\sqrt{2t^2 - 2t + 14}}$ $\sin \theta = \sqrt{1 - \frac{9}{2(t^2 - t + 7)}}$
