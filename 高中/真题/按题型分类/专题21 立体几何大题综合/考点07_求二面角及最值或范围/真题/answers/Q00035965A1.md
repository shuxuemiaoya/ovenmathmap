...
answer_source_body_sha256: 14c4648ca3dfba095fd4dde342fdfca2247a717127b835f1abf21a8311e70a7e
---

> [!faq]- 《专题21 立体几何大题综合》真题解析
>
> > [!success]- **【答案】** （Ⅰ）略；（Ⅱ） $60^{\circ}$ 【详解】试题分析：（Ⅰ）思路一：连接 DG, CD，设 $CD \cap GF = O$ ，连接 OH，先证明 $OH \parallel BD$ ，从而由直线与平面平行的判定定理得 BD // 平面 HDF；思路二：先证明平面 FGH // 平面 ABED，再由平面与平面平行的定义得到 BD // 平面 HDF。 （Ⅱ）思路一：连接 $DG, CD$ ，设 $CD \cap GF = O$ ，连接 $OH$ ，证明 $GB, GC, GD$ 两两垂直，以 $G$ 为坐标原点，建立如图所示的空间直角坐标系 $G - xyz$ ，利用空量向量的夹角公式求解；思路二：作 $HM \perp AC$ 于点 $M$ ，作 $MN \perp GF$ 于点 $N$ ，连接 $NH$ ，证明 $\angle MNH$ 即为所求的角，然后在三角形中求解。 试题
>
> > [!note]- **【分析】**
> > 本题未单列分析。
>
