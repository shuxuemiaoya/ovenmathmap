...
answer_source_body_sha256: 9530b802e9543f1a59f4fc8a3e6c21475e1690f73950ced2d3a3840a34f0c804
---

> [!faq]- 《专题21 立体几何大题综合》真题解析
>
> > [!success]- **【答案】** (1) 证明：直线 $CE \parallel$ 平面 $PAB$ ; (2) 点 $M$ 在棱 $PC$ 上，且直线 $BM$ 与底面 $ABCD$ 所成角为 $45^{\circ}$ ，求二面角 $M - AB - D$ 的余弦值. 【答案】（1）见解析；（2） $\frac{\sqrt{10}}{5}$
>
> > [!note]- **【分析】**
> > 本题未单列分析。
>
...
> > 试题分析：（1）取 $PA$ 的中点 $F$ ，连结 $EF$ ， $BF$ ，由题意证得 $CE \parallel BF$ ，利用线面平行的判断定理即可证得结论；（2）建立空间直角坐标系，求得半平面的法向量： $m = (0, -\sqrt{6}, 2)$ ， $n = (0, 0, 1)$ ，然后利用空间向量的相关结论可求得二面角 $M - AB - D$ 的余弦值为 $\frac{\sqrt{10}}{5}$ 。
