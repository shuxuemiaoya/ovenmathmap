...
answer_source_body_sha256: 64f3a48c96e5bd25a045b4cb3ef389c00c272991bea830c8548b8d5e43bc5fd2
---
...
>
> > [!note]- **【解析】**
> > 试题分析：（1）由面面垂直的判定定理很容易得结论；（2）所求三棱锥底面积容易求得，是本题转化为求三棱锥的高FC，利用直线 $A_{1}C$ 与平面 $A_{1}ABB_{1}$ 所成的角为 $45^{\circ}$ ，作出线面角，进而可求得 $AA_{1}$ 的值，则可得的FC长.
