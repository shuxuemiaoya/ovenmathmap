...
answer_source_body_sha256: 745e931489735effe4ba1005c3210a2b556f9c9ec87a753bf71640d3b5e1dbb8
---
...
>
> > [!note]- **【分析】**
> > (1)首先将平面 CDE 进行扩展，然后结合所得的平面与直线 $B_{1}C_{1}$ 的交点即可证得题中的结论；
> >
> > (2)建立空间直角坐标系，利用空间直角坐标系求得相应平面的法向量，然后解方程即可求得实数 $\lambda$ 的值.
>
> > [!note]- **【解析】**
> > (1)如图所示，取 $B_{1}C_{1}$ 的中点 $F'$ ，连结DE,EF',F'C
