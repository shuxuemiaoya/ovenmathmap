---
answer_for: "Q00055529"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: f2437fffd248c0b8da23a4e00823d3a1809f68d816fe4f472c7a6b76da46c5da
---
...
> >
> > (2) 法一：由
> > (1) 的信息，结合勾股定理的逆定理及线面垂直、面面垂直的判定推理作答·法二：过点 B
> >
...
> >
> > （3）法一：由
> > （2）的信息作出并证明二面角的平面角，再结合三角形重心及余弦定理求解作答·法二：求出平面 $ADO$ 与平面 $ACO$ 的法向量，由二面角的向量公式求解即可·
>
> > [!note]- **【解析】**
> > （1）连接 $DE, OF$ ，设 $AF = tAC$ ，则 $\overline{BF} = \overline{BA} + \overline{AF} = (1 - t)\overline{BA} + t\overline{BC}$ ， $AO = -\overline{BA} + \frac{1}{2}\overline{BC}$
> >
> > $$
> > B F \perp A O
> > $$
...
> >
> > (2) 法一：由
> > (1) 可知 $EF // OD$ ，则 $AO = \sqrt{6}, DO = \frac{\sqrt{6}}{2}$ ，得 $AD = \sqrt{5}DO = \frac{\sqrt{30}}{2}$ ，
> >
