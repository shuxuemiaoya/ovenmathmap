---
answer_for: "Q00055509"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 44c3eee4549c457abc5e85dd6d09f0cda802a7a8ce78d9fc3cd2e4806af96c5c
---
...
> > [!note]- **【解析】**
> > 分析：
> > （1）由面面垂直的性质定理可得 $AD^{\perp}$ 平面 ABC，则 $AD^{\perp}BC$
> >
...
> >
> > 详解：
> > （1）证明：由平面 $ABC^{\perp}$ 平面 $ABD$ ，平面 $ABC \cap$ 平面 $ABD = AB$ ， $AD^{\perp}AB$ ，可得 $AD^{\perp}$ 平面 $ABC$ ，故 $AD^{\perp}BC$ ：
> >
