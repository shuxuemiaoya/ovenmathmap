---
answer_for: "Q00055504"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 41042cebf46e3da17718c082704d09a48a0c59f42d4c92a83196546290530ce3
---
...
> >
> > 由
> > （1）知 $EF \perp$ 平面 $AMNA_{1}$ ，则 $EF$ 为平面 $AMNA_{1}$ 的垂线。
> >
...
> >
> > 由
> > （1）知， $B_{1}C_{1}\perp$ 平面 $A_{1}AMN$ ，则 $B_{1}C_{1}$ 为平面 $A_{1}AMN$ 的法向量.
> >
> > 因为 $AO \parallel$ 平面 $EB_{1}C_{1}F$ ， $AO \subseteq$ 平面 $A_{1}AMN$ ，且平面 $A_{1}AMN \cap$ 平面 $EB_{1}C_{1}F = PN$ ，所以 $AO \parallel PN$ ：
> >
> > 由
> > （1）知 $AA_{1} \parallel MN, AA_{1} = MN$ ，即四边形 $APNO$ 为平行四边形，则 $AO = NP = AB$ 。
> >
...
> >
> > 由
> > （1）知 $BC \perp$ 平面 $A_{1}AMN$ ，所以向量 $\overline{BC}$ 为平面 $A_{1}AMN$ 的法向量。
> >
