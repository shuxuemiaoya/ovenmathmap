---
answer_for: "Q00035914"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: b5786687e3152f7cdf6f29f0e574976b9f683d02a6ae4692b7d259db51088f99
---
...
>
> > [!note]- **【分析】**
> > （Ⅰ）由已知 $AD//BC$ ，故 $\angle DAP$ 或其补角即为异面直线 $AP$ 与 $BC$ 所成的角，然后在 Rt $\triangle PDA$ 中求解即可；（Ⅱ）因为 $AD \perp$ 平面 $PDC$ ，所以 $AD \perp PD$ ， $PD \perp BC$ ，又 $PD \perp PB$ ，所以 $PD \perp$ 平面 $PBC$ ；（Ⅲ）过点 $D$ 作 $AB$ 的平行线交 $BC$ 于点 $F$ ，连结 $PF$ ，则 $DF$ 与平面 $PBC$ 所成的角等于 $AB$ 与平面 $PBC$ 所成的角，且 $\angle DFP$ 为直线 $DF$ 和平面 $PBC$ 所成的角，然后在 Rt $\triangle DPF$ 中求解即可。
>
> > [!note]- **【解析】**
> > 解：（1）如图，由已知 $AD//BC$ ，故 $\angle DAP$ 或其补角即为异面直线 $AP$ 与 $BC$ 所成的角因为 $AD\bot$ 平面 $PDC$ ，所以 $AD\bot PD.$
> > 在 Rt△PDA 中，由已知，得 $AP = \sqrt{AD^{2} + PD^{2}} = \sqrt{5}$
> > 故 $\cos\angle DAP=\frac{AD}{AP}=\frac{\sqrt{5}}{5}$
> > 所以，异面直线 $AP$ 与 $BC$ 所成角的余弦值为 $\frac{\sqrt{5}}{5}$
> > ![](../../../images/questions/part-002/3edef5930df597e6e42a8c6f1251b4ac259b573a4f9644118bfd1519ca486340.jpg)
> > (II) 证明：因为 $AD \perp$ 平面 $PDC$ ，直线 $PD \subset$ 平面 $PDC$ ，所以 $AD \perp PD$ .
> > 又因为 BC//AD，所以 $PD \perp BC$
> > 又 $PD \perp PB$ ， $BC \cap PB = B$
> > 所以 $PD \perp$ 平面 PBC.
> > (III) 过点 $D$ 作 $AB$ 的平行线交 $BC$ 于点 $F$ , 连结 $PF$ ,
