---
answer_for: "Q00035907"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 6ab879bc577ec4205eb088320dbdfb3d8ca2dae6127fe5eda18ab7c4b74850ce
---
...
>
> > [!note]- **【分析】**
> > 【分析】（1）由 $M, N$ 分别为 $BC$ ， $B_{1}C_{1}$ 的中点， $MN//CC_{1}$ ，根据条件可得 $AA_{1}//BB_{1}$ ，可证 $MN//AA_{1}$ ，要证平面 $EB_{1}C_{1}F \perp$ 平面 $A_{1}AMN$ ，只需证明 $EF \perp$ 平面 $A_{1}AMN$ 即可；
> >
...
> > 又∵ $B_{1}C_{1}//BC$ ，且 $B_{1}C_{1}\not\subset$ 平面ABC， $BC\subset$ 平面ABC，
...
> > ![](../../../images/questions/part-002/6cdb9a0323008aa19afcc1ed932ceab9fc19ecedbc197a804fd86ca78d3e5aab.jpg)
...
> > 由（1）知 $EF \perp$ 平面 $AMNA_{1}$ ，则 $EF$ 为平面 $AMNA_{1}$ 的垂线。
...
> > 因为 $AO \parallel$ 平面 $EB_{1}C_{1}F$ ， $AO \subseteq$ 平面 $A_{1}AMN$ ，且平面 $A_{1}AMN \cap$ 平面 $EB_{1}C_{1}F = PN$ ，所以 $AO \parallel PN$ ：
> > 由（1）知 $AA_{1} \parallel MN, AA_{1} = MN$ ，即四边形 $APNO$ 为平行四边形，则 $AO = NP = AB$ 。
> > 因为 $O$ 为正 $\triangle A_{1}B_{1}C_{1}$ 的中心，故 $AP = ON = \frac{1}{3} AM$
> > 由面面平行的性质得 $EF\parallel \frac{1}{3} B_1C_1, EF = \frac{1}{3} B_1C_1$ ，所以四边形 $EFC_1B_1$ 为等腰梯形。
> > 由 P，N 为等腰梯形两底的中点，得 $PN \perp B_{1}C_{1}$ ，则 $PN \cdot B_{1}C_{1} = 0, EB_{1} = EP + PN + NB_{1} = \frac{1}{6}B_{1}C_{1} + PN - \frac{1}{2}B_{1}C_{1} = PN - \frac{1}{3}B_{1}C_{1}$ .
> > 设直线 与平面 所成角为 ，，则 $\sin \theta = \left|\frac{\boxed{\square\boxed{\square}}\cdot\boxed{\square\boxed{\square}\vec{B}}\cdot\boxed{B}\cdot\boxed{G}}{\left|\boxed{EB_{1}}\right|\left|\boxed{B_{1}C_{1}}\right|}\right| = \frac{\frac{1}{3}a^{2}}{a\sqrt{a^{2} + \left(\frac{1}{3}a\right)^{2}}} = \frac{\sqrt{10}}{10}$
...
> > $$
> > \begin{array}{c} \square \square \square \\ E B _ {1} = \square A + \square A _ {1} + \square A _ {1} B _ {1} = \frac {2}{3} A B + \square A _ {1} \\ , \quad \square C = \square A C - A B \end{array} ,
> > $$
...
> > 设直线 $B_{1}E$ 与平面 $A_{1}AMN$ 所成角 $\theta$ ，则 $\sin \theta = \left|\cos \left\langle \overrightarrow{EB_1}, \overrightarrow{BC}\right\rangle \right| = \left|\frac{\overrightarrow{EB_1} \cdot \overrightarrow{BC}}{\left|\overrightarrow{EB_1}\right| \left|BC\right|}\right| = \frac{\sqrt{10}}{10}$ 。
> > 故直线 $B_{1}E$ 与平面 $A_{1}AMN$ 所成角的正弦值为 $\sin \theta = \frac{\sqrt{10}}{10}$
> > [方法五]：坐标法
> > ![](../../../images/questions/part-002/84f63b187d861b093be1088443fb75f7f02d104a1db88e32d347fb26accf2029.jpg)
