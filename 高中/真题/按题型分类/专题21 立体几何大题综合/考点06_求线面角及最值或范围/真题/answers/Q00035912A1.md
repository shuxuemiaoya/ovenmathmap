---
answer_for: "Q00035912"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 8a3c46ce2b719f74602d07779b8d0bbbeebb5288e78332309f3604d14bc0fee5
---
...
>
> > [!note]- **【解析】**
> > 【答案】(Ⅰ)证明见解析；(Ⅱ) $\frac{\sqrt{13}}{26}$ ；(Ⅲ) $\frac{\sqrt{3}}{4}$
> > 【详解】分析：（1）由面面垂直的性质定理可得 $AD^{\perp}$ 平面 ABC，则 $AD^{\perp}BC$
...
> > (Ⅲ) 连接 $CM$ 。由题意可知 $CM^{\perp}$ 平面 $ABD$ 。则 $\angle CDM$ 为直线 $CD$ 与平面 $ABD$ 所成的角。计算可得
> > $\sin\angle CDM=\frac{CM}{CD}=\frac{\sqrt{3}}{4}$ ．即直线 CD 与平面 ABD 所成角的正弦值为 $\frac{\sqrt{3}}{4}$
> > 详解：（1）证明：由平面 $ABC^{\perp}$ 平面 $ABD$ ，平面 $ABC \cap$ 平面 $ABD = AB$ ， $AD^{\perp}AB$ ，可得 $AD^{\perp}$ 平面 $ABC$ ，故 $AD^{\perp}BC$ ：
> > (Ⅱ) 取棱 AC 的中点 N，连接 MN，ND．又因为 M 为棱 AB 的中点，故 $MN^{\parallel}BC$ ．所以 $\angle DMN$ （或其补角）为异面直线 BC 与 MD 所成的角．
> > ![](../../../images/questions/part-002/d953d935cbbc15ac86839e18e3927f89662b356b2c1f92b9c6217e4723f4204b.jpg)
