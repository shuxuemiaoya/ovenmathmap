...
answer_source_body_sha256: a46a1add4ea8b3fb7855ce5e055b5c7bc91d0828bcefeafca035dd848fa917ec
---
...
>
> > [!note]- **【分析】**
> > （1）通过△PDC为等腰三角形可得 $PE_{\perp}CD$ ，利用线面垂直判定定理及性质定理即得结论；（2）通过（1）及面面垂直定理可得 $PG_{\perp}AD$ ，则∠PDC为二面角PAD.C的平面角，利用勾股定理即得结论；（3）连结AC，利用勾股定理及已知条件可得 $FG\|AC$ ，在△PAC中，利用余弦定理即得直线PA与直线FG所成角的余弦值．
>
> > [!note]- **【解析】**
