---
answer_for: "Q00035751"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: e1635200daaa6667d4658da85fd8be4c40757c630b7b88177a51ef1703def4e3
---
...
>
> > [!note]- **【分析】**
> > 【分析】（1）建立空间直角坐标系，求出 $D_{1}F$ 及平面 $A_{1}EC_{1}$ 的一个法向量m，证明 $D_{1}F\perp m$ ，即可得证；
>
> > [!note]- **【解析】**
...
> > 设平面 $A_{1}EC_{1}$ 的一个法向量为 $m=\left(x_{1},y_{1},z_{1}\right)$
