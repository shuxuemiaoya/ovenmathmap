---
answer_for: "Q00055571"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 87ec4e2343e608f70c661fcd61fed24785b70832c2a0e69d976d229b7d22b1ce
---
...
> >
> > 【详解】试题分析：
> > （1）取 $PA$ 的中点 $F$ ，连结 $EF$ ， $BF$ ，由题意证得 $CE \parallel BF$ ，利用线面平行的判断定理即可证得结论；
> > （2）建立空间直角坐标系，求得半平面的法向量： $m = (0, -\sqrt{6}, 2)$ ， $n = (0, 0, 1)$ ，然后利用空间向量的相关结论可求得二面角 $M - AB - D$ 的余弦值为 $\frac{\sqrt{10}}{5}$ 。
> >
> > 试题解析： $
...
> >
> > 点睛:
> > (1) 求解本题要注意两点: ①两平面的法向量的夹角不一定是所求的二面角, ②利用方程思想进行向量运算, 要认真细心、准确计算.
> >
