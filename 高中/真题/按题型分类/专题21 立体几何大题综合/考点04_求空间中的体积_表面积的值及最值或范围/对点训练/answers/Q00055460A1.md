---
answer_for: "Q00055460"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: fb51fc00c9f72b28ee9be5accee43d9f19567ad0a79516d9c724e5a8cc2e7b87
---
...
>
> > [!note]- **【分析】**
> > （1）先证明 $\triangle ABC$ 为等腰直角三角形，然后利用体积公式可得三棱锥的体积；
> >
> > (2) 将所给的几何体进行补形，从而把线线垂直的问题转化为证明线面垂直，然后再由线面垂直可得题中的结论：
>
> > [!note]- **【解析】**
> > （1）由于 $BF \perp A_{1}B_{1}$ ， $AB //A_{1}B_{1}$ ，所以 $AB \perp BF$ ，
> >
...
> >
> > (2) 由
> > (1) 的结论可将几何体补形为一个棱长为 $^{2}$ 的正方体 $ABCM-A_{1}B_{1}C_{1}M_{1}$ ，如图所示，取棱 $AM,BC$ 的中点 $H,G$ ，连结 $A_{1}H,HG,GB_{1}$ ，
> >
