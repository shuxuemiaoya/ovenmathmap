---
answer_for: "Q00055468"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 04e4b6ec5d2ef68c5741552facb3e4105ccea2cedb70ac79a7d1732ca0266cd9
---
...
> >
> > 【详解】试题分析：
> > （1）由 $\angle BAP = \angle CDP = 90^{\circ}$ ，得 $AB\perp AP$ ， $CD\perp PD$ 。从而得 $AB\perp PD$ ，进而而 $AB\perp$ 平面PAD，由面面垂直的判定定理可得平面 $PAB\perp$ 平面PAD；
> > （2）设 $PA = PD = AB = DC = a$ ，取 $AD$ 中点 $O$ ，连结 $PO$ ，则 $PO\perp$ 底面ABCD，且 $AD = \sqrt{2} a,PO = \frac{\sqrt{2}}{2} a$ ，由四棱锥 $P - ABCD$ 的体积为 $\frac{8}{3}$ 求出 $a = 2$ ，由此能求出该四棱锥的侧面积·
> >
> > 试题解析：
