---
answer_for: "Q00055865"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 940b3aaafb616b6bebda130f5950d71582766c45e3d567cb83e963c4a65ae2d8
---
...
>
> > [!note]- **【分析】**
> > （1）由题意得 $b=c=\sqrt{2}$ ，进一步得a，由此即可得解；
> >
...
>
> > [!note]- **【解析】**
> > （1）由题意 $b=c=\frac{2}{\sqrt{2}}=\sqrt{2}$ ，从而 $a=\sqrt{b^{2}+c^{2}}=2$ ，
> >
> > 所以椭圆方程为 $\frac{x^2}{4} +\frac{y^2}{2} = 1$ ，离心率为 $e = \frac{\sqrt{2}}{2}$
> >
> > (2) 直线 AB 斜率不为 0，否则直线 AB 与椭圆无交点，矛盾，
> >
> > ![](../../../images/questions/3e00d09ebd1d61f6426cd7a3a92ac987f7f2dfcb4848b4db708476a90152db1e.jpg)
> >
...
> >
> > 得 $y_{C}=\frac{x_{1}y_{2}+x_{2}y_{1}}{x_{1}+x_{2}}=\frac{x_{1}(kx_{2}+t)+x_{2}(kx_{1}+t)}{x_{1}+x_{2}}=\frac{2kx_{1}x_{2}+t(x_{1}+x_{2})}{x_{1}+x_{2}}=\frac{4k(t^{2}-2)}{-4kt}+t=\frac{2}{t}=1$
> >
> > 所以 t = 2 ，
> >
