---
answer_for: "Q00055891"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: f618f95ce4dea24808c605e8e879970f123587011261ca1c7dd8af5fdaf97b33
---
> [!faq]- 《zhenti-专题24 圆锥曲线》例题解析
>
> > [!success]- **【答案】** $^{ (1)}$ 取值范围是 $(-∞, -3) ∪ (-3, 0) ∪ (0, 1)$ (2)证明过程见解析
>
> > [!note]- **【分析】**
> > （1）方法一：设而不求，利用点差法进行证明。
> >
...
> >
> > 由
> > （1）有 $k = -\frac{3}{4m} = -1$ ，直线 $l$ 的方程为 $y = -x + \frac{7}{4}$ ，将其与椭圆方程联立消去 $y$ 得 $28x^{2} - 56x + 1 = 0$ ，求得 $x_{1,2} = \frac{14 \pm 3\sqrt{21}}{14}$ ，不妨设 $x_{A} < x_{B}$ ，所以 $x_{A} = \frac{14 - 3\sqrt{21}}{14}$ ， $x_{B} = \frac{14 + 3\sqrt{21}}{14}$
> >
