---
answer_for: "Q00055816"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 3a7820af64b9d4f7c705a4dc37f03069155e0b30f42bc88ad5506fed5ee0d628
---
...
> >
> > (2) [方法四]由
> > (1) 可得出 $C_1$ 的方程为 $\frac{x^2}{4c^2} + \frac{y^2}{3c^2} = 1$ ，联立曲线 $C_1$ 与 $C_2$ 的方程，求出点 $M$ 的坐标，利用抛物线的定义结合 $|MF| = 5$ 可求得 $c$ 的值，进而可得出 $C_1$ 与 $C_2$ 的标准方程.
>
> > [!note]- **【解析】**
...
> > 则直线 AB 的方程为 x = c ，
> >
> > 联立 $\left\{\begin{aligned}x&=c\\\frac{x^{2}}{a^{2}}+\frac{y^{2}}{b^{2}}&=1\\ a^{2}&=b^{2}+c^{2}\end{aligned}\right.$ ，解得 $\left\{\begin{aligned}x&=c\\ y&=\pm\frac{b^{2}}{a}\end{aligned}\right.$ ，则 $\left|AB\right|=\frac{2b^{2}}{a}$ ，
> >
> > ![](../../../images/questions/ec6136e128fadfa069a334db2e437135d9d069255864de8f3b5932f1e286ec8f.jpg)
> >
> > 抛物线 $C_2$ 的方程为 $y^{2} = 4cx$ ，联立 $\left\{ \begin{array}{l}x = c\\ y^2 = 4cx \end{array} \right.$
> >
...
> >
> > 所以 $a - \frac{1}{2} x_0 = 5$ ，即 $x_0 = 2a - 10$
> >
...
> >
> > 由（Ⅰ）知 $a = 2c$ ，又由圆锥曲线统一的极坐标公式 $\left|MF\right| = \frac{2c}{1 - \cos\theta}$ ，得 $2c = 5 - 5\cos \theta$ ，由 $|MF| = \frac{\frac{1}{2}\times 3c}{1 + \frac{1}{2}\cos\theta}$ ，得 $3c = 10 + 5\cos \theta$ ，两式联立解得
> >
...
> >
> > 由
> > （1）知 $a = 2c, b = \sqrt{3}c$ ，椭圆 $C_1$ 的方程为 $\frac{x^2}{4c^2} + \frac{y^2}{3c^2} = 1$
> >
...
> >
> > 因此，曲线 $C_1$ 的标准方程为 $\frac{x^2}{36} +\frac{y^2}{27} = 1$
> >
