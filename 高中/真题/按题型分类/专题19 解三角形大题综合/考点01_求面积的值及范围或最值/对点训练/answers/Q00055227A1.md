---
answer_for: "Q00055227"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 99ca188b5df51ccf9d59a5dc10ab57fc9902b6d7060f6c06ac6dfdac34dd5a23
---
...
> >
> > 由题设及
> > （1）知 $\triangle ABC$ 的面积 $S_{\triangle ABC} = \frac{\sqrt{3}}{4} a$
> >
...
> >
> > 由题设及
> > （1）知 $\triangle ABC$ 的面积 $S_{\triangle ABC} = \frac{\sqrt{3}}{4} a$ ，因为 $\triangle ABC$ 为锐角三角形，且 $c = 1, B = \frac{\pi}{3}$
> >
...
> >
> > 【整体点评】 $^{
> > (1)}$ 方法一：正弦定理是解三角形的核心定理，与三角形内角和相结合是常用的方法；
> >
