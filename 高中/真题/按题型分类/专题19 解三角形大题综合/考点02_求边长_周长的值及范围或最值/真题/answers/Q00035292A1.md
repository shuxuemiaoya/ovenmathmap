...
answer_source_body_sha256: 77b902112f4e49e3bf59fca29491804502b11f2767b0c46fb48fc01c315f0c68
---
...
>
> > [!note]- **【分析】**
> > 【分析】（1）方法 $^{1}$ ，利用三角形面积公式求出a，再利用余弦定理求解作答；方法 $^{2}$ ，利用三角形面积公式求出a，作出BC边上的高，利用直角三角形求解作答.
> >
> > (2) 方法 $^{1}$ ，利用余弦定理求出 a，再利用三角形面积公式求出 $\angle ADC$ 即可求解作答；方法 $^{2}$ ，利用向量运算律建立关系求出 a，再利用三角形面积公式求出 $\angle ADC$ 即可求解作答.
>
> > [!note]- **【解析】**
> > 【详解】（1）方法 $^{1}$ ：在 $\triangle ABC$ 中，因为D为BC中点， $\angle ADC=\frac{\pi}{3}$ ，AD=1，
