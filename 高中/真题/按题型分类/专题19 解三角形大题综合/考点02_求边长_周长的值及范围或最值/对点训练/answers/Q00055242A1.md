---
answer_for: "Q00055242"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: d7b4dad464529102b41007171eb673eb8cb5cc18f3b186055a17f9abc6a50e79
---
...
>
> > [!note]- **【分析】**
> > （1）方法一：根据正弦定理得到 $\frac{BD}{\sin\angle A} = \frac{AB}{\sin\angle ADB}$ ，求得 $\sin \angle ADB = \frac{\sqrt{2}}{5}$ ，结合角的范围，利用同角三角函数关系式，求得 $\cos \angle ADB = \sqrt{1 - \frac{2}{25}} = \frac{\sqrt{23}}{5}$ ；
> >
...
> > [方法 $^{2}$ ]：余弦定理
> >
> > 在 $\triangle ABD$ 中， $BD^{2} = AB^{2} + AD^{2} - 2AB\cdot AD\cos 45^{\circ}$ ，即 $25 = 4 + AD^{2} - 2\times 2\times AD\times \frac{\sqrt{2}}{2}$ ，解得： $AD = \sqrt{2} +\sqrt{23}$ ，所以，
> >
> > $$
...
> >
> > ![](../../../images/questions/8dc77953501d5e68d9222b7187f5e41666b89133941b6d26627c30ed83f6afd2.jpg)
> >
> > [方法 $^{4}$ ]：坐标法
> >
...
> >
> > $\cos \angle ADB = \sin \alpha = \sqrt{1 - \cos^2\alpha} = \frac{\sqrt{23}}{5}$
> >
> > (2) [方法1]：【通性通法】余弦定理
> >
> > 在 $\triangle BCD$ ，由
> > （1）得， $\cos \angle ADB = \frac{\sqrt{23}}{5}$ ， $BC^{2} = BD^{2} + DC^{2} - 2BD\cdot DC\cos (90^{\circ} - \angle ADB)$
> >
...
> >
> > 【整体点评】
> > （1）方法一：根据题目条件已知两边和一边对角，利用正弦定理和平方关系解三角形，属于通性通法；
> >
