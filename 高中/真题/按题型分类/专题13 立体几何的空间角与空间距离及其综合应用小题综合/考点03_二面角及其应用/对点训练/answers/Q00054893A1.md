...
>
> > [!note]- **【解析】**
> > 取 $AB$ 的中点 $E$ ，连接 $CE, DE$ ，因为 $\triangle ABC$ 是等腰直角三角形，且 $AB$ 为斜边，则有 $CE \perp AB$ 又 $\triangle ABD$ 是等边三角形，则 $DE \perp AB$ ，从而 $\angle CED$ 为二面角 $C - AB - D$ 的平面角，即 $\angle CED = 150^{\circ}$ ，
> >
