...
>
> > [!note]- **【解析】**
> > 设 O 为三角形 ABC 中心，则正四面体 D-ABC 的顶点在底面 ABC 的投影为 O，过 O 分别作 PR、PQ、RQ 的垂线，垂足分别为 E、F、G，连结 DE、DF、DG，则有 $\alpha=\angle DEO,\beta=\angle DFO,\gamma=\angle DGO,$ 所以 $\tan\alpha=\frac{OD}{OE},\tan\beta=\frac{OD}{OF},\tan\gamma=\frac{OD}{OG}$
> >
> > 只需比较 $OE$ 、 $OF$ 、 $OG$ 的大小：
> >
