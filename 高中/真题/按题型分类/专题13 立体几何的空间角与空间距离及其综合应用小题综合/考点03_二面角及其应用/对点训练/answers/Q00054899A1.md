...
>
> > [!note]- **【解析】**
> > 设 $\angle ADC = \theta$ ，设 AB = 2，则由题意 AD = BD = 1，在空间图形中，设 $A'B = t$ ，在 $\Delta A'DB$ 中， $\cos \angle A'DB = \frac{A'D^{2} + DB^{2} - AB^{2}}{2A'D \times DB} = \frac{1^{2} + 1^{2} - t^{2}}{2 \times 1 \times 1} = \frac{2 - t^{2}}{2}$ ，
> >
