---
answer_for: "Q00036415"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 4648a98cb2ae6e9319e623f35db0fa1db9a3adccf0c1c19fbab3a754cb7d73ef
---
...
> > ![](../../../images/questions/part-002/4ccc217855e7a792876ac3825f5a12ac767bbfe2c326710a3d0f88ba52a17fc5.jpg)
...
> > 故 $\frac{1}{2} C\sqrt{\frac{27}{4}} = \frac{3\sqrt{3}}{2}$ 即 $C3\sqrt{3}$
...
> > ![](../../../images/questions/part-002/5aac1bfa630ff4462965db3e7c381251b505ac4b30ae95b863a7c6f23a167526.jpg)
> > 依题意可设 $A\left(a,a^2 +\frac{1}{4}\right)$ ，易知直线 $BA$ ， $DA$ 的斜率均存在且不为0，
...
> > 设 $B^{'}(t_{0},t_{0}^{2}), A^{'}(t_{1},t_{1}^{2}), C^{'}(t_{2},t_{2}^{2})$ ，根据对称性不妨设 $t_{0}$ 0.
...
> > 故 $0 \leq t_{0} < \frac{\tan \theta}{2}$ , 由此 $\left|A^{\prime}B^{\prime}\right| + \left|B^{\prime}C^{\prime}\right| = \frac{2t_{0}(\cos \theta - \sin \theta)}{\sin \theta \cos \theta} + \frac{\sin^{3} \theta + \cos^{3} \theta}{\sin^{2} \theta \cos^{2} \theta}$
> > $$
...
> > $$
> > 当且仅当 $\cos \theta = \frac{\sqrt{3}}{3}$ 时等号成立，故 $\left|A'B'\right| + \left|B'C'\right| > \frac{3\sqrt{3}}{2}$ ，故矩形周长大于 $3\sqrt{3}$
> > ![](../../../images/questions/part-002/1419b15efbecc909abcfc9acafed7614f966ba9ba30e3a571089b67a72a21623.jpg)
> > ![](../../../images/questions/part-002/4280d4e848dbfcd5dbe4c35e19ddd0d02724acba605a7beb38b60027a62aebbc.jpg)
