---
answer_for: "Q00055598"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 19ed12d7d88ba2e6a26756a965e4d9159c849519e3d92fe157635e5cd1fa457e
---
...
> >
> > $$
> > P (A _ {i + 1}) = P (A _ {i} A _ {i + 1}) + P (B _ {i} A _ {i + 1}) = P (A _ {i}) P (A _ {i + 1} \mid A _ {i}) + P (B _ {i}) P (A _ {i + 1} \mid B _ {i})
> > $$
> >
...
> >
> > 设 $p_{i + 1} + \lambda = \frac{2}{5}\big(p_i + \lambda\big)$ ，解得 $\lambda = -\frac{1}{3}$ ，则 $p_{i + 1} - \frac{1}{3} = \frac{2}{5}\left(p_i - \frac{1}{3}\right)$
> >
