...
>
> > [!note]- **【分析】**
> > 先求得焦点坐标，从而求得 $p$ ，根据弦长公式求得 $\left|MN\right|$ ，根据圆与等腰三角形的知识确定正确答案· 【详解】A选项：直线 $y = -\sqrt{3}(x - 1)$ 过点 $(1,0)$ ，所以抛物线 $C:y^{2} = 2px(p > 0)$ 的焦点 $F(1,0)$ ，所以 $\frac{p}{2} = 1,p = 2,2p = 4$ ，则A选项正确，且抛物线 $C$ 的方程为 $y^{2} = 4x$
>
> > [!note]- **【解析】**
