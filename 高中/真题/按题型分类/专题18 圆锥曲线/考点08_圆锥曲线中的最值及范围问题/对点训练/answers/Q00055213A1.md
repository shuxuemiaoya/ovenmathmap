...
>
> > [!tip]- **【名师点睛】**
> > 本题主要考查了求双曲线焦距的最值问题，解题关键是掌握双曲线渐近线的定义和均值不等式求最值方法，在使用均值不等式求最值时，要检验等号是否成立，考查了分析能力和计算能力，属于中档题·5．（2018·浙江·高考真题）已知点 $P(0,1)$ ，椭圆 $\frac{x^2}{4} + y^2 = m (m > 1)$ 上两点 $A$ ， $B$ 满足 $\overline{AP} = 2PB$ ，则当 $m =$ 时，点 $B$ 横坐标的绝对值最大．
> >
> > 【答案】5
> >
