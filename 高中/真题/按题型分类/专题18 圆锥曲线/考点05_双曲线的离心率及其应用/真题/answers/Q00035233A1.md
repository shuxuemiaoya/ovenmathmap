---
answer_for: "Q00035233"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 12d443bc702010b542bd25c6714f1a23ff44a85be99ad735a74281fe23c8fb39
---
...
>
> > [!note]- **【分析】**
> > 【分析】方法一：由正六边形性质得渐近线的倾斜角，解得双曲线中 $m^{2}, n^{2}$ 关系，即得双曲线N的离心率；由正六边形性质得椭圆上一点到两焦点距离之和为 $c + \sqrt{3}c$ ，再根据椭圆定义得 $c + \sqrt{3}c = 2a$ ，解得椭圆M的离心率·
>
> > [!note]- **【解析】**
> > 【详解】[方法一]：【最优解】数形结合+定义法
...
> > ![](../../../images/questions/4fee1f779e5eb023f9694c1b0b3c708ceea8a855971841bf23c145cb3e1afa5c.jpg)
> > 故答案为： $\sqrt{3}-1$ ；2。
> > [方法二]：数形结合+齐次式求离心率
> > 设双曲线 $\frac{x^2}{m^2} -\frac{y^2}{n^2} = 1$ 的一条渐近线 $y = \frac{n}{m} x$ 与椭圆 $\frac{x^2}{a^2} +\frac{y^2}{b^2} = 1$ 在第一象限的交点为 $A(x_0,y_0)$ ，椭圆的右焦点为 $F_{2}(c,0)$ .由题可知， $A,F_{2}$ 为正六边形相邻的两个顶点，所以 $\angle AOF_2 = 60^\circ$ （ $O$ 为坐标原点）.
