...
>
> > [!note]- **【分析】**
> > 【分析】根据题意，根据 $P, A, F_{1}$ 三点共线，求出直线 $AF_{1}$ 的方程，联立双曲线方程，即可求得 $P$ 点坐标，则由 $S_{\Delta APF} = S_{\Delta AFF_{1}} - S_{\Delta PFF_{1}}$ 即可容易求得·
>
> > [!note]- **【解析】**
> > 【详解】设双曲线的左焦点为 $F_{1}$ ，由双曲线定义知， $\left|PF\right| = 2a + \left|PF_1\right|$
