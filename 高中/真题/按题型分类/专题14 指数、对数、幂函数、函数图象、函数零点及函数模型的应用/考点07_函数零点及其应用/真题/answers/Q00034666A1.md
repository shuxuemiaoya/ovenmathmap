...
>
> > [!note]- **【分析】**
> > 【分析】当 $x < 0$ 时， $y = f(x) - ax - b = x - ax - b = (1 - a)x - b$ 最多一个零点；当 $x = 0$ 时， $y = f(x) - ax - b = \frac{1}{3} x^3 - \frac{1}{2}(a + 1)x^2 + ax - ax - b = \frac{1}{3} x^3 - \frac{1}{2}(a + 1)x^2 - b$ ，利用导数研究函数的单调性，根据单调性画函数草图，根据草图可得。
>
> > [!note]- **【解析】**
> > 【详解】当 $x < 0$ 时， $y = f(x) - ax - b = x - ax - b = (1 - a)x - b = 0$ ，得 $x = \frac{b}{1 - a}$ ； $y = f(x) - ax - b$ 最多一个零点；
