---
answer_for: "Q00054845"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 9a129b941d7034e736fb294ef1335c505fd92bcc0204e65ce878a56c81f3c2c7
---
...
> >
> > 所以 $V'(t) < 0$ ，函数 $V(t)$ 在 $[1,2]$ 上单调递减，故 $V(t) \leq V
> > (1) = \frac{1}{6} \left( \frac{4}{1} - 1 \right) = \frac{1}{2}$ .
> >
...
> >
> > 由
> > （1）可知，函数 $V(t)$ 在(1,2]单调递减，故 $V(t) < V
> > (1) = \frac{1}{6} (\frac{4}{1} - 1) = \frac{1}{2}$ .
> >
