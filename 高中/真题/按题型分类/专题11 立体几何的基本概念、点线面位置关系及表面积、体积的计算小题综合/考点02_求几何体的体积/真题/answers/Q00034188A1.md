...
>
> > [!note]- **【分析】**
> > 分别过 M, C 作 $MM' \perp PA, CC' \perp PA$ ，垂足分别为 $M', C'$ · 过 B 作 $BB' \perp$ 平面 PAC，垂足为 $B'$ ，连接 $PB'$ ，过 N 作 $NN' \perp PB'$ ，垂足为 $N'$ · 先证 $NN' \perp$ 平面 PAC，则可得到 $BB' // NN'$ ，再证 $MM' // CC'$ · 由三角形相似得到 $\frac{MM'}{CC'} = \frac{1}{3}$ ， $\frac{NN'}{BB'} = \frac{2}{3}$ ，再由 $\frac{V_{P - AMN}}{V_{P - ABC}} = \frac{V_{N - PAM}}{V_{B - PAC}}$ 即可求出体积比
>
> > [!note]- **【解析】**
> > 如图，分别过 $M, C$ 作 $MM' \perp PA, CC' \perp PA$ ，垂足分别为 $M', C'$ ·过 $B$ 作 $BB' \perp$ 平面 $PAC$ ，垂足为 $B'$ ，连接 $PB'$ ，过 $N$ 作 $NN' \perp PB'$ ，垂足为 $N'$ .
