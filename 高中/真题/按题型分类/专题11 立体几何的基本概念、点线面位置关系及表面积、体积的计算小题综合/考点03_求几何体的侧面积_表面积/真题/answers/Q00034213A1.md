...
>
> > [!note]- **【分析】**
> > 法一：利用全等三角形的证明方法依次证得 $\triangle PDO \cong \triangle PCO$ ， $\triangle PDB \cong \triangle PCA$ ，从而得到 $PA = PB$ ，再在 $\triangle PAC$ 中利用余弦定理求得 $PA = \sqrt{17}$ ，从而求得 $PB = \sqrt{17}$ ，由此在 $\triangle PBC$ 中利用余弦定理与三角形面积公式即可得解；
