---
answer_for: "Q00039754"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: c2eec17e8bf2c7af1a34c51278461be39c2111f254e755988093351145b5beb8
---
...
> > 由 N 为 PC 的中点知 $TN \parallel BC$ ， $TN = \frac{1}{2} BC = 2$ 。又 $AD \parallel BC$ ，故 TN 續 AM，
> > 四边形 AMNT 为平行四边形，于是 MN // AT.
> > 因为 $AT \subset$ 平面 PAB， $MN \notin$ 平面 PAB，所以 $MN \parallel$ 平面 PAB.
> > ![](../../../images/questions/1187a80f647844e0a9dc73d7eb7248a6c60d4ae97edae86f95a275bbd8755863.jpg)
...
> > 设 $n=(x,y,z)$ 为平面 PMN 的法向量，则 $\left\{\begin{aligned}n\cdot\overrightarrow{PM}&=0,\\ n\cdot\overrightarrow{PN}&=0,\end{aligned}\right.$ 即 $\left\{\begin{aligned}2y-4z&=0,\\ \frac{\sqrt{5}}{2}x+y-2z&=0,\end{aligned}\right.$
> > 可取 $n=(0,2,1)$ .
