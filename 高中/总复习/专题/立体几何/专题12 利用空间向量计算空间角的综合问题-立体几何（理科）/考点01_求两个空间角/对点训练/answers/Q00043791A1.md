---
answer_for: "Q00043791"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: b2015b192474c84e346b92d4120fae52fd40e9d53a3cf3b48bcaac9e77868c59
---
...
> > 5. 解析
> > (1)如图所示, 连接 $A_{1}C_{1}$ , $B_{1}D_{1}$ 相交于 $O$ , 连接 $OE$ , $EF$ ,
...
> > (3)在
> > (2)建立的空间直角坐标系中，设平面设平面 $A_{1}AC_{1}$ 的法向量 $\boldsymbol{n}_{2}=(x_{2},y_{2},z_{2})$ ,
...
> > 设直线 $AC_{1}$ 与平面 $A_{1}EC_{1}$ 所成的角为 $\theta$ ，则 $\sin\theta=|\cos<n_{1},\quad\overrightarrow{AC_{1}}>|=\frac{|n_{1}\cdot\overrightarrow{AC_{1}}|}{|n_{1}|\cdot|\overrightarrow{AC_{1}}|}=\frac{\sqrt{3}}{9}.$
> > 设二面角 $A-A_{1}C_{1}-E$ 为 $\alpha$ ，根据
> > (2)有 $\cos\alpha=\frac{|n_{1}\cdot n_{2}|}{|n_{1}|\cdot|n_{2}|}=-\frac{2\sqrt{2}}{3}$ ，所以 $\sin\alpha=\frac{1}{3}$ .
