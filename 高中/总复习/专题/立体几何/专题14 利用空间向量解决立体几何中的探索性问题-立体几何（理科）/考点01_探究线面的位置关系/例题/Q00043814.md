...
question_body_sha256: 2d2bb6b3e98c906915c94a6146c088bf987dfa2b7d56ea2e723a914a7b053ea1
source_pdf_page: 5
...
(1)因为 $PA \perp$ 平面 $ABCD$ , $CD \subset$ 平面 $ABCD$ , 所以 $PA \perp CD$ .
...
所以 $\overrightarrow{AG} = \overrightarrow{AP} +\overrightarrow{PG} = \left(\frac{4}{3}, - \frac{2}{3},\frac{2}{3}\right)$ 由
(2)知，平面 $AEF$ 的一个法向量 $\pmb {n} = (-1, - 1,1),$
