---
answer_for: "Q00039913"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 27e58dbf107ff358ba38552c7df9637e650ff35314d9f3b736add5e7383678ff
---
...
> > 解析 (1) 因为 $A|A \perp$ 底面 $ABCD$ ，所以 $A|A \perp AC$ .
...
> > (2)如图，以 A 为原点建立空间直角坐标系 A-xyz，依题意可得 $A(0, 0, 0)$ ， $B(0, 1, 0)$ ， $C(2, 0, 0)$ ， $D(1, -2, 0)$ ， $D_{1}(1, -2, 2)$ ， $E\left(0, 0, \frac{1}{2}\right)$ 。由(1)知， $\overrightarrow{EB}=\left(0, 1, -\frac{1}{2}\right)$ 为平面 $ACB_{1}$ 的一个法向量。
...
> > (3)假设存在满足题意的点 $F$ 。设 $A_{1}F = a (a > 0)$ ，则由(2)得 $F(0, a, 2)$ ， $\vec{DF} = (-1, a + 2, 2)$ .
