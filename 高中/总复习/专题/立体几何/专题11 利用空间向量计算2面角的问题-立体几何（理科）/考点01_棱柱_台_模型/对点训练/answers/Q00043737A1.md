---
answer_for: "Q00043737"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: eb98daab8524940960f42ba99ef1cff979b948e4196437689515cd9e8098c19f
---
...
> >
> > 3. 解析
> > (1)由已知，得 $B_{1}C_{1} \perp$ 平面 $ABB_{1}A_{1}$ ，由于 $BE \subset$ 平面 $ABB_{1}A_{1}$ ，
> >
> > 故 $B_{1}C_{1} \perp BE$ 。又 $BE \perp EC_{1}$ ， $B_{1}C_{1} \cap EC_{1} = C_{1}$ ，所以 $BE \perp$ 平面 $EB_{1}C_{1}$
> >
> > (2)由
> > (1)知 $\angle BEB_{1}=90^{\circ}$ ．由题设知 Rt $\triangle ABE\cong$ Rt $\triangle A_{1}B_{1}E$ ，所以 $\angle AEB=45^{\circ}$ ，故 $AE=AB$ ， $AA_{1}=2AB$ ．
> >
