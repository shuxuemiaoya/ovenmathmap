---
answer_for: "Q00039655"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: fb88eb7f61cec4c9b4f52ca9370155bcda62d5943efc5a928aac7bbb1e9ed2d7
---
...
> > 解析 (1)方法一 取 $PA$ 的中点 $H$ , 连接 $EH, DH$ . 因为 $E$ 为 $PB$ 的中点, 所以 $EH \parallel \frac{1}{2} AB$ . 又 $CD \parallel \frac{1}{2} AB$ , 所以 $EH \parallel CD$ . 所以四边形 $DCEH$ 是平行四边形, 所以 $CE \parallel DH$ . 又 $DH \subset$ 平面 $PAD$ , $CE \not\subset$ 平面 $PAD$ , 所以 $CE \parallel$ 平面 $PAD$ .
