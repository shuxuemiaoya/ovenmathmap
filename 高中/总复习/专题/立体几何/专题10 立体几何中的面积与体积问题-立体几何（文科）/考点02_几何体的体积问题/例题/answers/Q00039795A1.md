---
answer_for: "Q00039795"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: 7ed48d5b0ce1eac1115c1928421e71d30238c7f8752a0a69dceddbc8c2a0e9e2
---
...
> > ∵E为AC的中点，∴EF为△ACD的中位线，
> > $$
> > \text {由(1)知，} V _ {F - B C E} = V _ {B - C E F} = \frac {1}{3} \times S _ {\triangle C E F} \times B C, S _ {\triangle C E F} = \frac {1}{4} S _ {\triangle A C D} = \frac {1}{4} \times \frac {1}{2} \times 2 \times 2 = \frac {1}{2}, \therefore V _ {F - B C E} = \frac {1}{3} \times \frac {1}{2} \times 2 \sqrt {2} = \frac {\sqrt {2}}{3}.
> > $$
