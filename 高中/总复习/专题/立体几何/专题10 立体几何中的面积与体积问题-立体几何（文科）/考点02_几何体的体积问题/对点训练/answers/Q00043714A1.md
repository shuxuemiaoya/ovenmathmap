---
answer_for: "Q00043714"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: fbebdf4164f4e2a86899fb538f4164cf86ff82bd8abac2f5774cde79d7926b32
---
...
> > 2. 解析
> > (1)如图，连接 $ED$ ， $\because$ 平面 $AB_{1}C \cap$ 平面 $A_{1}BD = ED$ ， $B_{1}C //$ 平面 $A_{1}BD$ ， $\therefore B_{1}C // ED$
...
> > (2)由 AB=1，得 $BC=BB_{1}=1$ ，由
> > (1)知 $AD=\frac{1}{2}AC$ ，又 $AC\cdot AD=1$ ，∴ $AC^{2}=2$ ，
> > $$
