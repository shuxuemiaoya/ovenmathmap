---
answer_for: "Q00039782"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: bf40a4e96ca93b89a48025261ff1cd85e361fbe5e05b4f7c52cc56dc6d5694d6
---
...
> > 8. 解析 (1)因为点 $E$ 为 $AB$ 的中点, $AB \parallel CD$ , $AB = 2CD$ , 所以 $BE = CD$ 且 $BE \parallel CD$ , 所以四边形 $BCDE$ 是平行四边形。连接 $BD$ 交 $CE$ 于点 $O$ , 则点 $O$ 为 $BD$ 的中点, 连接 $FO$ , 因为点 $F$ 为 $PB$ 的中点, 所以 $PD \parallel FO$ , 又 $PD \nparallel$ 平面 $CEF$ , $FO \subset$ 平面 $CEF$ , 所以 $PD \parallel$ 平面 $CEF$ .
