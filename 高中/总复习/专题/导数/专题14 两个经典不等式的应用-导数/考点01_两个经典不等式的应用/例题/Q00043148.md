...
question_body_sha256: ddd859dce2bb2377dd94055c4638ee6f3b5dd72f741fa0fee7cbd26b3f3e35ee
source_pdf_page: 2
...
(1)函数 $f(x)$ 的定义域为 $x \in (-1, +\infty)$ , $f'(x) = \frac{1}{x + 1} - a = \frac{-ax + 1 - a}{x + 1}$ .
...
![[高中/总复习/专题/导数/专题14 两个经典不等式的应用-导数/考点01_两个经典不等式的应用/例题/answers/Q00043148A1.md]]
