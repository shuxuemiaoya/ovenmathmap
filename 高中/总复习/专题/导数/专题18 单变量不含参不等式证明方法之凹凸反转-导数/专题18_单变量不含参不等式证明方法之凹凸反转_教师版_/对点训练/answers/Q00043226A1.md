---
answer_for: "Q00043226"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 7b5475cc5843c756bb36f86500eded60fde8af2460fa0f3b5cdee964efc69e96
---
...
> >
> > 6. 解析
> > (1)由 $f(x)=x \ln x$ ，x>0，得 $f'(x)=\ln x+1$ ，令 $f'(x)=0$ ，得 $x=\frac{1}{e}$ .
> >
...
> >
> > 由
> > (1)可知 $f(x)=x\ln x(x\in(0,+\infty))$ 的最小值是 $-\frac{1}{e}$ ，当且仅当 $x=\frac{1}{e}$ 时取到.
> >
...
> >
> > 易知 $m(x)_{\max} = m
> > (1) = -\frac{1}{\mathrm{e}}$ ，当且仅当 $x = 1$ 时取到.
> >
