---
answer_for: "Q00043231"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 644b895188b58fe385a447fc01ac15b9e277859a943b25317a3d5278fd7b4ea8
---
...
> >
> > 1. 解析
> > (1) $f(x)$ 的定义域为 $(0, +\infty)$ ，当 a=0 时， $f(x)=\ln x$ 在 $(0, +\infty)$ 上单调递增；
> >
...
> >
> > 所以 $h(x)$ 在 $(0, 1)$ 上单调递减，在 $(1, +\infty)$ 上单调递增，所以 $h(x)_{\min}=h
> > (1)=0$ ，
> >
> > 所以当 x>0 时， $h(x)\geq h
> > (1)=0$ ，即当 x>0 时， $x-1\geq\ln x$ ，
> >
