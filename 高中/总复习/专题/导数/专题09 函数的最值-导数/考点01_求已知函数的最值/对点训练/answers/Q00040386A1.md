---
answer_for: "Q00040386"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: f6156b8829e0e70dfe4b922d005143c9f7c12d63229ae754d330037557afea30
---
...
> > [ - 5, + \infty)
> > $$
> > 12. 解析 $(1)f'(x) = \frac{(2ax + b)e^x - (ax^2 + bx + c)e^x}{(e^x)^2} = \frac{-ax^2 + (2a - b)x + b - c}{e^x}$ . 令 $g(x) = -ax^2 + (2a - b)x + b - c$ ,
