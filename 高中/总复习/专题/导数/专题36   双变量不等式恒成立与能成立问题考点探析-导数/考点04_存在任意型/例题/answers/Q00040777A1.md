---
answer_for: "Q00040777"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: 2e464638531a7911dd0c89a5687948a3484d84b727204191e04ee01acfc6eb5f
---
...
> > 解析 $(1)f'(x) = \frac{1 - a - \ln x}{x^2} (x > 0)$ . 由 $f'(x) = 0$ ，得 $x = \mathrm{e}^{1 - a}$ . 易知 $f'(x)$ 在 $(0, +\infty)$ 上单调递减，
...
> > 而 $F(2) = \mathrm{e}^2 - 8 < 0$ ， $F(3) = \mathrm{e}^3 - 9 > 0$ ： $\therefore F(2) \cdot F(3) < 0$
