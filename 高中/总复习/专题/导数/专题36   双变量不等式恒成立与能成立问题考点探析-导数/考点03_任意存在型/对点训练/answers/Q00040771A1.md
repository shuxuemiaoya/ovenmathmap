---
answer_for: "Q00040771"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: b337c1db313ce5fc6611b42f2ed19e1fbcb0ec9fd9468c2879a9db9fa729427a
---
...
> > $\therefore \left\{ \begin{array}{l} f'(1) = 3 + 2b + c = 0 \\ f'(2) = 12 + 4b + c = 0 \end{array} \right.$ 解得 $b = -\frac{9}{2}, c = 6, \therefore f(x) = x^3 - \frac{9}{2}x^2 + 6x + 1;$
> > (2)由(1)得 $f'(x)=3x^{2}+2bx+c=3(x-1)(x-2)$
> > 当 $x \in [2, +\infty)$ ， $f'(x) \geq 0$ ，∴ $f(x)$ 在 $[2, +\infty)$ 上单调递增，∴ $f(x)_{\min} = f(2) = 3$ ;
