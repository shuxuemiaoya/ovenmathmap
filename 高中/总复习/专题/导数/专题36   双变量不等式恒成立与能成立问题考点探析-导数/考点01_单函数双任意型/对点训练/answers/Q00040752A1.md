---
answer_for: "Q00040752"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: aba3543b6e4eef5b17c44a21019bac107d9f263e361a02390f5517c91d5ff221
---
...
> > 所以 x=2 为极小值点，极小值 $f(2)=\frac{3}{2}-\frac{5\ln2}{2}$ .
...
> > 由(1)可知 $g(x)=-\frac{5}{2}\ln x+x-\frac{1}{x}$ 在 $\left[\frac{1}{2},1\right]$ 上为减函数．所以当 $\frac{1}{2}\leq x<1$ 时， $g(x)\leq g\left(\frac{1}{2}\right)=\frac{5}{2}\ln2-\frac{3}{2}$ .
