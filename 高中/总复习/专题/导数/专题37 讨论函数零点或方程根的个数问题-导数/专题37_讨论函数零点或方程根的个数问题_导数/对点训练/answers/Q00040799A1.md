---
answer_for: "Q00040799"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: b0640d3d6271db2d06f782a332d6941baf7ea7d3fe4e149d098127241246586a
---
...
> > (ii)当 $a = 0$ 时， $f(x)$ 在 $[1, \mathrm{e}^2]$ 上单调递增，而 $f(1) = -\frac{1}{2} a = 0$ ，故 $f(x)$ 在 $[1, \mathrm{e}^2]$ 上有一个零点.
> > (iii)当 $a > 0$ 时，①若 $\frac{\sqrt{a}}{a} \leq 1$ ，即 $a \geq 1$ 时， $f(x)$ 在 $[1, \mathrm{e}^2]$ 上单调递减.
> > 因为 $f(1) = -\frac{1}{2} a < 0$ ，所以 $f(x)$ 在 $[1, \mathrm{e}^2]$ 上没有零点.
...
> > $$
> > f (1) = - \frac {1}{2} a <   0, f \left(\frac {\sqrt {a}}{a}\right) = - \frac {1}{2} \ln a - \frac {1}{2}, f \left(\mathrm{e} ^ {2}\right) = 2 - \frac {1}{2} a \mathrm{e} ^ {4},
> > $$
...
> > 因为 $f(1) = -\frac{1}{2} a < 0$ ， $f(\mathrm{e}^2) = 2 - \frac{1}{2} a\mathrm{e}^4 >0$ ，所以 $f(x)$ 在[1， $\mathbf{e}^2 ]$ 上有一个零点.
