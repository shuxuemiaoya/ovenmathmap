---
answer_for: "Q00040791"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: 4c90a73dd9d0845d1b07dc5625ec084bdd63ef5acd23de851e71d9da1262c483
---
...
> > (1)求 $f(x)$ 的单调区间；
> > (2)讨论方程 $f(x)=1$ 根的个数.
> > [规范解答] (1)函数 $f(x)$ 的定义域为 $(0, +\infty)$ , $f'(x) = \frac{a - b - a\ln x}{x^2}$ , 由 $f'(1) = a - b = -a$ , 得 $b = 2a$ , 所以 $f(x) = \frac{a(\ln x + 2)}{x}$ , $f'(x) = -\frac{a(\ln x + 1)}{x^2}$ .
