---
answer_for: "Q00040737"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: fcdd195fc171431c6f40b2ef54d664d73cf73965ecca274b1a8db00add10bdfa
---
...
> > 解析 (1) 因为 $f(x) = \frac{1}{2} \ln x - mx, x > 0$ ，所以 $f'(x) = \frac{1}{2x} - m$ ，
...
> > 等价于对 $\forall x\in [2, 2\mathrm{e}^2 ]$ 都有 $g(x)_{\min}\geq f(x)_{\max}$ ，由(1)知在[2， $2\mathrm{e}^2 ]$ 上 $f(x)$ 的最大值为 $f(\mathrm{e}^2) = \frac{1}{2},$
