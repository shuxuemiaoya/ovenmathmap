---
answer_for: "Q00040739"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: 0280ea31da20ba6f967be4f8329ea27cff685c9343d7db65a90263bc19b46e5a
---
...
> > $$
> > g (x) _ {\max} = g (2) = 1, \quad g (x) _ {\min} = g \left(\frac {2}{3}\right) = - \frac {8 5}{2 7}.
> > $$
...
> > 设 $h(x) = x - x^2\ln x$ ， $x\in \left[\frac{1}{2},2\right]$ ，则 $h^\prime (x) = 1 - 2x\ln x - x$ ，易知 $h^\prime (x)$ 在区间 $\left[\frac{1}{2},2\right]$ 上是减函数，又 $h^\prime (1) = 0$ ，所以当 $1 <   x <   2$ 时， $h^\prime (x) <   0$ ；当 $\frac{1}{2} <  x <   1$ 时， $h^\prime (x) > 0$
