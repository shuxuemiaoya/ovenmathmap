---
answer_for: "Q00043143"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 2eb801f993191c3f2ade2347568c322abe98ebf076de0360e1c81d3ab44027e0
---
...
> > [!note]- **【解析】**
> > 解析 $
> > (1)f(x) = \frac{1}{x} + a\ln x, x \in (0, +\infty)$ . $f'(x) = -\frac{1}{x^2} + \frac{a}{x} = \frac{ax - 1}{x^2}$ . 当 $a \leq 0$ 时， $f'(x) < 0$ ，函数 $f(x)$ 在 $x \in (0, +\infty)$ 上单调递减.
> >
