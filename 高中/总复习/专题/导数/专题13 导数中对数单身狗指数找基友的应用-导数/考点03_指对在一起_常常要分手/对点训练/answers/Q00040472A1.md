---
answer_for: "Q00040472"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 38b1edd21b81ada2be53d507ab0fa14dc0d49deb50a9639b31382e5650e25692
---
...
> > 3. 解析 $(1)f(x) = \frac{1}{x} + a\ln x, x \in (0, +\infty)$ . $f'(x) = -\frac{1}{x^2} + \frac{a}{x} = \frac{ax - 1}{x^2}$ . 当 $a \leq 0$ 时， $f'(x) < 0$ ，函数 $f(x)$ 在 $x \in (0, +\infty)$ 上单调递减.
