---
answer_for: "Q00040600"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: b9052f21dec0e3d784b6dea05c28ca2f44508cd3e1e7f04484502fb6a96508b2
---
...
> > (2)法一：构造差函数法
> > 由(1)易知 a>0，且 $f(x)$ 在 $\left[\begin{matrix}0,&\frac{1}{a}\end{matrix}\right]$ 上单调递增，在 $\left[\begin{matrix}\frac{1}{a},&+\infty\end{matrix}\right]$ 上单调递减，不妨设 $0<x_{1}<\frac{1}{a}<x_{2}$
