---
answer_for: "Q00043305"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 83a38fcda7da7bd667e47183c57e321f21dd1ae925c9603d75e292e9ee7bab82
---
...
> > [!note]- **【解析】**
> > 解析
> > (1) $x \in (0, +\infty)$ . $f'(x) = 2x - (a - 2) - \frac{a}{x} = \frac{2x^2 - (a - 2)x - a}{x} = \frac{(2x - a)(x + 1)}{x}$ .
> >
...
> >
> > (2) $\because x_{1}$ ， $x_{2}$ 是方程 $f(x)=c$ 得两个不等实数根，由
> > (1)可知：a>0.
> >
...
> >
> > ∵ $f'(\frac{a}{2})=0$ ，当 $x\in(0,\frac{a}{2})$ 时， $f'(x)<0$ ，当 $x\in(\frac{a}{2},+\infty)$ 时， $f'(x)>0$ 。
> >
...
> >
> > $\because 1 > t > 0, \therefore g'(t) > 0. \therefore g(t)$ 在 $(0,1)$ 上是增函数，又在 $t = 1$ 处连续且 $g
> > (1) = 0$
> >
