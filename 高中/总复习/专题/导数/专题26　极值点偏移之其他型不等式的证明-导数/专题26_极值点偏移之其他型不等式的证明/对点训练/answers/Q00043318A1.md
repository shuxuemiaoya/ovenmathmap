---
answer_for: "Q00043318"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: c780b01364a654396dfff5930f4df66b6d12a9a98c19af57027f243b32cecd43
---
...
> > 法二：构造以 $a$ 为主元的函数，设函数 $h(a) = f\left(\frac{1}{a} + x\right) > f\left(\frac{1}{a} - x\right)$ ，
> > 则 $h(a)=\ln(1+ax)-\ln(1-ax)-2ax$ ， $h'(a)=\frac{x}{1+ax}+\frac{x}{1-ax}-2x=\frac{2x^{3}a^{2}}{1-a^{2}x^{2}}$
