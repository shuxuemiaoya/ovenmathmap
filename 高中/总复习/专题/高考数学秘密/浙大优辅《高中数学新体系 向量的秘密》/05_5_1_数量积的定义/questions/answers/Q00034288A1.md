...
>
> > [!note]- **【分析】**
> > 分析 注意到 $\overrightarrow{T_iT_{i+1}}\cdot\overrightarrow{T_{i+1}T_{i+2}}=\left|\overrightarrow{T_iT_{i+1}}\right|\left|\overrightarrow{T_{i+1}T_{i+2}}\right|\cos\theta$ ，其中的三要素 $\left|\overrightarrow{T_iT_{i+1}}\right|$ ， $\left|\overrightarrow{T_{i+1}T_{i+2}}\right|$ ， $\cos\theta$ 均是已知的。
> >
