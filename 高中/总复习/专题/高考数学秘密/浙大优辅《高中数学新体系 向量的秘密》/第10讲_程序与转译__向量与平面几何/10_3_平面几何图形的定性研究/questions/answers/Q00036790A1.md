---
answer_for: "Q00036790"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: 6815075c7301c1431cc5fe0a8516826b2d86bbf64d2a917428d7a8a51d260fbf
---
...
>
> > [!note]- **【分析】**
> > 题中的四边形 ABCD 是确定的四边形还是变化的四边形？在 $\triangle ABD$ 中，已知 AB = 5, $BD = \sqrt{14}$ , $\cos \angle BAD = \frac{3}{4}$ 这三个条件，故 $\triangle ABD$ 是确定的三角形。又由 $\angle BAC = \angle CAD$ 知 AC 是 $\angle BAD$ 的角平分线，且 $AC = \sqrt{14}$ ，故点 C 也是确定的，因此四边形 ABCD 是确定的四边形。
>
> > [!note]- **【解析】**
