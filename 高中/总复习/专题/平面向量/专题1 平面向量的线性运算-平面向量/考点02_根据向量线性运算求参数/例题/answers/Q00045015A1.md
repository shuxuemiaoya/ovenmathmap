...
answer_source_body_sha256: 2e164b6352de8434f7ed414b0e4cfeddf6dd0cbc7bb3556c87778d312fc51f51
---
...
> >
> > 优
> > 解：如图所示，假设点 P 在矩形的对角线 BD 上，由题意易知 $\left|\overrightarrow{DB}\right|=2,\quad\angle ADB=60^{\circ}$ ，又 $\angle DAP=30^{\circ}$ ，所以 $\angle DPA=90^{\circ}$ 。由 $\left|\overrightarrow{AD}\right|=1$ ，可得 $\left|\overrightarrow{DP}\right|=\frac{1}{2}=\frac{1}{4}\left|\overrightarrow{DB}\right|$ ，从而可得 $\overrightarrow{AP}=\overrightarrow{AD}+\overrightarrow{DP}=\overrightarrow{AD}+\frac{1}{4}\overrightarrow{DB}=\overrightarrow{AD}+\frac{1}{4}\left(\overrightarrow{AB}-\overrightarrow{AD}\right)=\frac{3}{4}\overrightarrow{AD}+\frac{1}{4}\overrightarrow{AB}$ 。又 $\overrightarrow{AP}=m\overrightarrow{AD}+\mathrm{n}\overrightarrow{AB}$ ，所以 $m=\frac{3}{4},\quad n=\frac{1}{4}$ ，则 $\frac{m}{n}=3$ 。
> >
> > 故选 **B**.
