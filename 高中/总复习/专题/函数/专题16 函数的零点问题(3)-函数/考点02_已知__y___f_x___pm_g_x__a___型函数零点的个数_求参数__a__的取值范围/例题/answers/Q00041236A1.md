---
answer_for: "Q00041236"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: 6184adb1179778a047445cfc6528f6ebdaf5c97956e39daac2ddb4b502bb4de7
---
...
> > 可知 $m(x)$ 与 $n(x)$ 为偶函数, 且要使 $m(x)$ 与 $n(x)$ 图象有交点, 需 a > 0, 由题意知要满足 $g(x)$ 在区间 $[-2\ 018, 2\ 018]$ 上有 4032 个零点, 只需 $m(x)$ 与 $n(x)$ 的图象在 $[0, 4]$ 上有两个交点, 则 $\left\{\begin{aligned}m(1) &<n(1), \\ m(3) &>n(3),\end{aligned}\right.$ 可得 $e < a < e^{3}$ , 故选 B.
> > 【对点训练】
