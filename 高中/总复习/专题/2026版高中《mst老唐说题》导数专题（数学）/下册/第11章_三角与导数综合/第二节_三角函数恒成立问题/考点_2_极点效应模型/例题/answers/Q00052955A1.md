---
answer_for: "Q00052955"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: 0dd629b0afbf9ec67bb78dd8ebba47921208ea2aaeeb94efa2a795f97f0c5ff9
---
> [!faq]- 《导数专题(下册)》例题解析
>
> > [!success]- **【答案】** 详见解析
>
> > [!note]- **【解析】**
> > 解析 (1) $f'(x)=ae^{x}+axe^{x}=a(x+1)e^{x}$ ，当 a>0 时，令 $f'(x)>0$ ，得 x>-1；令 $f'(x)<0$ ，得 x<-1；所以 $f(x)$ 在 $(-∞,-1)$ 上单调递减，在 $(-1,+∞)$ 上单调递增，所以 $f(x)_{\text{极小值}}=f(-1)=-\frac{a}{e}$ 。当 a<0 时，令 $f'(x)>0$ 得 x<-1；令 $f'(x)<0$ 得 x>-1，所以 $f(x)$ 在 $(-∞,$
> >
