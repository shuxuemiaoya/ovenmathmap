...
解析
(1) 由 $f(x) = e^{ax} \sin x$ 得 $f(0) = 0$ ，又 $f'(x) = e^{ax} (a \sin x + \cos x)$ ，则 $k = f'(0) = 1$ ，故切线方程为 $y = x$ .
...
(3)由
(2)可知，当 $a = 1$ 且 $x \in \left(0, \frac{\pi}{2}\right)$ 时， $f(x) > x$ ，故 $\sum_{i=1}^{n} f(x_i) > \sum_{i=1}^{n} x_i = \frac{\pi}{2}$ ，当 $a = 1$ 时， $f'(x) = e^x (\sin x + \cos x)$ ，令 $m(x) = e^x (\sin x + \cos x)$ ，则 $m'(x) = 2e^x \cos x > 0$ ，其中 $x \in \left(0, \frac{\pi}{2}\right)$ ，故 $f'(x)$ 单调递增，设 $F(x) = f(x + y) - f(x) - f(y)$ ，其中 $x, y \in \left(0, \frac{\pi}{2}\right)$ ，且 $x + y < \frac{\pi}{2}$ ，
...
![[高中/总复习/专题/2026版高中《mst老唐说题》导数专题（数学）/下册/第10章_导数不等式与数列综合/第四节_导数与数列迭代放缩与求和/例题/Q00046914.md]]
![[高中/总复习/专题/2026版高中《mst老唐说题》导数专题（数学）/下册/第10章_导数不等式与数列综合/第四节_导数与数列迭代放缩与求和/例题/Q00046915.md]]
![[高中/总复习/专题/2026版高中《mst老唐说题》导数专题（数学）/下册/第10章_导数不等式与数列综合/第四节_导数与数列迭代放缩与求和/例题/Q00046916.md]]
![[高中/总复习/专题/2026版高中《mst老唐说题》导数专题（数学）/下册/第10章_导数不等式与数列综合/第四节_导数与数列迭代放缩与求和/例题/Q00046917.md]]
![[高中/总复习/专题/2026版高中《mst老唐说题》导数专题（数学）/下册/第10章_导数不等式与数列综合/第四节_导数与数列迭代放缩与求和/例题/Q00046918.md]]
![[高中/总复习/专题/2026版高中《mst老唐说题》导数专题（数学）/下册/第10章_导数不等式与数列综合/第四节_导数与数列迭代放缩与求和/例题/Q00046919.md]]
