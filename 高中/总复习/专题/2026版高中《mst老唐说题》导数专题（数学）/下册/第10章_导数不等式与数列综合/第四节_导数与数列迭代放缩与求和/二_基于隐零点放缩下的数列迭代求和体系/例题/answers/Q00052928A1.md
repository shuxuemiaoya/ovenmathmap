---
answer_for: "Q00052928"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: 3f8464682d09074b09a472fafbb7e3ea6bb807258b6c5fb07899b50b55d1ebcc
---
> [!faq]- 《导数专题(下册)》例题解析
>
> > [!success]- **【答案】** 详见解析
>
> > [!note]- **【解析】**
> > 解析 解；(1)证明：要证 $f_{1}(x)\geqslant 2 - \frac{2}{x}$ ，即证 $\ln x + \frac{1}{x} -1\geqslant 0$ 设 $g(x) = \ln x + \frac{1}{x} -1$ 对 $g(x)$ 求导得 $g^{\prime}(x) = \frac{x - 1}{x^{2}}$ ，当 $0 <   x <   1$ ， $g^{\prime}(x) <   0$ ， $g(x)$ 递减；当 $x > 1$ ， $g^{\prime}(x) > 0$ ， $g(x)$ 递增所以 $g(x)$ 在 $x = 1$ 取最小值， $g(1) = \ln 1 + \frac{1}{1} -1 = 0$ ，即 $g(x)\geqslant 0$ ，原不等式得证.
> >
...
> >
> > (3)对函数求导，导数 $f_{n}^{\prime}(x)=\frac{1}{x}+\frac{n}{x^{2}}$ ，在x>0时大于0，函数递增. $f_{n}(1)=1-n\leqslant0$
> >
