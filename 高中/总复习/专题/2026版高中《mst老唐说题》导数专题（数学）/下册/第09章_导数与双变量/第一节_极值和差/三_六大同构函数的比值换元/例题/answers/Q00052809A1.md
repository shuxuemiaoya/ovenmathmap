---
answer_for: "Q00052809"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: e16545be9036493834992d8a20237534ae3b9f78307a7ceac65390807028bdbb
---
> [!faq]- 《导数专题(下册)》例题解析
>
> > [!success]- **【答案】** 详见解析
>
> > [!note]- **【解析】**
> > 解析 (1) 法一因为 $f(x) = x - a\mathrm{e}^{x}$ ，所以 $f'(x) = 1 - a\mathrm{e}^{x}$ ；下面分两种情况讨论： $① a \leqslant 0$ 时， $f'(x) > 0$ 在 $\mathbb{R}$ 上恒成立，所以 $f(x)$ 在 $\mathbb{R}$ 上是增函数，不合题意； $② a > 0$ 时，由 $f'(x) = 0$ ，得 $x = -\ln a$ ，当 $x$ 变化时， $f'(x)$ 、 $f(x)$ 的变化情况如下表：
> >
