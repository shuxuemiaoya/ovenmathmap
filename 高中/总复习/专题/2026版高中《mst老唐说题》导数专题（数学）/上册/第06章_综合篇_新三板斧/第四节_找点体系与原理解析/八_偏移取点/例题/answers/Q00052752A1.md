---
answer_for: "Q00052752"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: 5564382be1f8dec120083ccfc8f32937f362713014def2de49c8eae9b0f09ab0
---
> [!faq]- 《导数专题(上册)》例题解析
>
> > [!success]- **【答案】** 详见解析
...
> >
> > 证明: (i)由(1)可知: $f'(x)=\frac{1-ax^2e^x}{x}, x \in (0, +\infty)$ . 令 $g(x)=1-ax^2e^x$ , $g'(x)=-a(x^2+2x)e^x$ , 因为 $0<a<\frac{1}{e}$ , 可知: $g(x)$ 在 $x \in (0, +\infty)$ 上单调递减, 又 $g(1)=1-ae>0$ . 导函数的零点不可求, 我们就需要先对导函数放缩取点, 对此需要采用等效零点分析, 具体操作如下:
> >
