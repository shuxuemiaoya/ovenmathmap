---
answer_for: "Q00052612"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: bbb4634ac5e9c743cdb39b624c44fb92fe2c09649b6550aa943adf2bb5125edb
---
> [!faq]- 《导数专题(上册)》例题解析
>
> > [!success]- **【答案】** 详见解析
>
> > [!note]- **【解析】**
> > 解析 (1) 当 $a = 0$ 时 $f(x) = \mathrm{e}^{x} - 1 - x, f'(x) = \mathrm{e}^{x} - 1$ . 当 $x \in (-\infty, 0)$ 时, $f'(x) < 0$ ; 当 $x \in (0,$
> >
