---
answer_for: "Q00052788"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: cbf0ce4df7392a74a63b479e6c0f69c77527590118ff7164f88c02f10642d065
---
> [!faq]- 《导数专题(上册)》例题解析
>
> > [!success]- **【答案】** 详见解析
...
> >
> > 当 $a \leqslant 0$ 时， $|e^x - \frac{a}{x}| - a \ln x + a = e^x - \frac{a}{x} + a - a \ln x = e^x - a\left(\frac{1}{x} - 1 - \ln \frac{1}{x}\right) > 0$ ，符合题意；当 $0 < a < e^{e+1}$ 时，由(1)知 $f(x) = xe^x - a$ 在 $(0, +\infty)$ 上单调递增，又 $f(0) = -a < 0$ ， $f(a) = a(e^a - 1) > 0$ ，所以 $\exists x_0 \in (0, a)$ ，使得 $f(x_0) = x_0 e^{x_0} - a = 0$ ，所以 $a = x_0 e^{x_0}$ ，因为 $0 < a < e^{e+1}$ ，所以 $0 < x_0 e^{x_0} < e^{e+1}$ ，所以 $0 < x_0 < e$ 。
> >
