...
question_body_sha256: d3ee279143e591cdade8769abdecc0cb971cce220fd2556f1a31b9a6a194dd60
source_pdf_page: 282
...
(1) 因为 $f(x) = \frac{x + 1}{\mathrm{e}^x} + ax^2$ ，其中 $a \in \mathbb{R}$ ， $x \in \mathbb{R}$ ，所以 $f'(x) = \frac{-x}{\mathrm{e}^x} + 2ax = \frac{x}{\mathrm{e}^x} (2ae^x - 1)$ ，①当 $a \leqslant 0$ 时，由 $2ae^x - 1 < 0$ ，令 $f'(x) = 0$ ，解得 $x = 0$ ，所以当 $x < 0$ 时，令 $f'(x) > 0$ ，当 $x > 0$ 时，令 $f'(x) < 0$ ，则 $f(x)$ 在 $(-\infty, 0)$ 上单调递增，在 $(0, +\infty)$ 上单调递减；
...
![[高中/总复习/专题/2026版高中《mst老唐说题》导数专题（数学）/上册/第07章_综合篇_显点探路/第三节_极值显点探路与零点个数问题/二_利用显点效应来构造极值点零点不等式/例题/answers/Q00047375A1.md]]
