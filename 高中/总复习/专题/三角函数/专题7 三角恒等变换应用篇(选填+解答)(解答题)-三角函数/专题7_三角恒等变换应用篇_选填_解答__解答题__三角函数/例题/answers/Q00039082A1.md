---
answer_for: "Q00039082"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: b3f36207b6ae923e4f5cd8145828292df605105df612f67c0958a7d160f06419
---
...
> > 解 (1) $f(x)=2\sqrt{3}\sin^{2}x-(1-2\sin x\cos x)=\sqrt{3}(1-\cos 2x)+\sin 2x-1=\sin 2x-\sqrt{3}\cos 2x+\sqrt{3}-1$ $=2\sin\left(2x-\frac{\pi}{3}\right)+\sqrt{3}-1.$ 由 $2k\pi-\frac{\pi}{2}\leq2x-\frac{\pi}{3}\leq2k\pi+\frac{\pi}{2}(k\in\mathbf{Z})$ ，得 $k\pi-\frac{\pi}{12}\leq x\leq k\pi+\frac{5\pi}{12}(k\in\mathbf{Z})$
