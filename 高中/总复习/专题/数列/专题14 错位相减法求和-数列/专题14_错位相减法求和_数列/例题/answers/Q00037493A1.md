---
answer_for: "Q00037493"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: b92f64c9b17ae825a5a564d04b462ba6ca8973a9c9b81e196c5b52e86667afcc
---
...
> > (2)由(1)知， $a_{n} = 2n$ ，所以 $S_{n} = \frac{n(2 + 2n)}{2} = n^{2} + n$ 所以 $b_{n} = a_{n}\cdot 4\frac{S_{n}}{a_{n}} = 2n\cdot 4\frac{n^{2} + n}{2n} = 2n\cdot 2^{n + 1} = n\cdot 2^{n + 2},$
