---
answer_for: "Q00040082"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: d015bdc72fed1a110f9a6bbc4e6b046bcde61271eb1b2887c0e3b3220bb992ff
---
...
> > 5. 解析 (1) 点 $P$ 的直角坐标为 $\left[\frac{3\sqrt{2}}{2}, \frac{3\sqrt{2}}{2}\right]$ ，由 $\rho = 2\cos \left(\theta - \frac{\pi}{4}\right)$ ，得 $\rho^2 = \sqrt{2}\rho \cos \theta + \sqrt{2}\rho \sin \theta$ ，①．将 $\rho^2 = x^2 + y^2$ ， $\rho \cos \theta = x$ ， $\rho \sin \theta = y$ 代入①，可得曲线 C 的直角坐标方程为 $\left(x-\frac{\sqrt{2}}{2}\right)^{2}+\left(y-\frac{\sqrt{2}}{2}\right)^{2}=1.$
