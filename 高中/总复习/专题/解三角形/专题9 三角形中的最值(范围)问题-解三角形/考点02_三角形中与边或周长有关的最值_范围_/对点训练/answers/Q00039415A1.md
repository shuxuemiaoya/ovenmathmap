---
answer_for: "Q00039415"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 4c052217726863acfc0a490085f920d5da96d5034da887d2ceeb89c9995960eb
---
...
> > 4. 解析 (1)由题意知 $1 - \sin^2 A = \sin^2 B + 1 - \sin^2 C + \sin A\sin B$ 即 $\sin^2 A + \sin^2 B - \sin^2 C = -\sin A\sin B$ ，由正弦定理得 $a^2 + b^2 - c^2 = -ab$ 由余弦定理得 $\cos C=\frac{a^{2}+b^{2}-c^{2}}{2ab}=\frac{-ab}{2ab}=-\frac{1}{2}$ ，又 $\because0<C<\pi,\therefore C=\frac{2\pi}{3}$ .
