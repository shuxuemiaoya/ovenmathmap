---
answer_for: "Q00042679"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 7cbfd6d800167799a3725010674c98c97227cc75a510bda3dfb479092ed9729c
---
...
> > 5. 解析
> > (1) 设直线 l 的方程为 $y = kx + t$ ，设 $A(x_{1}, y_{1})$ ， $B(x_{2}, y_{2})$ ，由 $\left\{\begin{aligned}y &= kx + t, \\ \frac{x^{2}}{4} + \frac{y^{2}}{3} &= 1,\end{aligned}\right.$
