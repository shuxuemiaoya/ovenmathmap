...
question_body_sha256: 950fbb222388b4662a7faf9401bb5e4e69fcbeb8c00c92d17201971d93649c91
source_pdf_page: 3
...
(2)设直线 $l$ 与
(1)中轨迹相切于点 $P$ , 与直线 $x = 4$ 相交于点 $Q$ , 判断以 $PQ$ 为直径的圆是否过 $x$ 轴上一定点.

[规范解答]
(1) 设 $C(x, y)$ . 由题意得 $k_{AC} \cdot k_{BC} = \frac{y}{x + 2} \cdot \frac{y}{x - 2} = -\frac{3}{4} (y \neq 0)$ . 整理，得 $\frac{x^{2}}{4} + \frac{y^{2}}{3} = 1 (y \neq 0)$ .
