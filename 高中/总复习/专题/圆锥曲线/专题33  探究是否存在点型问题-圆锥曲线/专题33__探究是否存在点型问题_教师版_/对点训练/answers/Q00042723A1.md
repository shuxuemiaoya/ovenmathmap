---
answer_for: "Q00042723"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 5fd6da6f6cc5870ee283710504d70735aabe7824ffc8773bdc091a39130ee539
---
...
> >
> > 2. 解析
> > (1)设椭圆 $C$ 的方程为 $\frac{x^2}{a^2} + \frac{y^2}{b^2} = 1 (a > b > 0)$ ，因为椭圆的左焦点为 $F_1(-2,0)$ ，所以 $a^2 - b^2 = 4$ 。由题可得椭圆的右焦点为 $F_2(2,0)$ ，已知点 $B(2, \sqrt{2})$ 在椭圆 $C$ 上，由椭圆的定义知 $|BF_1| + |BF_2| = 2a$ ，所以 $2a = 3\sqrt{2} + \sqrt{2} = 4\sqrt{2}$ ，所以 $a = 2\sqrt{2}$ ，从而 $b = 2$ 。所以椭圆 $C$ 的方程为 $\frac{x^2}{8} + \frac{y^2}{4} = 1$ 。
> >
