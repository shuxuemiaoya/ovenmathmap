---
answer_for: "Q00042696"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: f84b4fa77ea85b4a3e689b29bef0ef2105b14a6b93c45869133f56ace2ffa059
---
...
> >
> > 6. 解析
> > (1)由题意可知 $BC$ 垂直于 $x$ 轴, $a = 4$ . 设 $B(2 + r, y_0)(r$ 为圆 $G$ 的半径),
> >
...
> >
> > (2)由
> > (1)可知 $M(0,1)$ ，设过点 $M(0,1)$ 与圆 $(x - 2)^{2} + y^{2} = \frac{4}{9}$ 相切的直线方程为： $y = kx + 1$ ，①
> >
