---
answer_for: "Q00042619"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: eb067bca27e6a7497eb5451119ec5e2944f07a24deddbfa0daa2387b727ec624
---
...
> >
> > 2. 解析
> > (1) $\because e^{2} = \frac{c^{2}}{a^{2}} = \frac{a^{2} - b^{2}}{a^{2}} = \frac{3}{4}, \therefore a^{2} = 4b^{2}$ , 又 $\frac{4}{a^{2}} + \frac{1}{b^{2}} = 1, \therefore a^{2} = 8, b^{2} = 2$ .
> >
