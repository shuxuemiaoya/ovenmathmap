---
answer_for: "Q00042509"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 04b898d77303185ad5e1ad720ee65859076bb1fbdb71aaf0a36c72f255962534
---
...
> > 3. 解析
> > (1)由题意可得： $\left\{\begin{aligned}&c=\frac{\sqrt{3}}{2},\\&4+\frac{1}{b^{2}}=1,\\&a^{2}=b^{2}+c^{2},\end{aligned}\right.$ 解得： $a^{2}=8$ ， $b^{2}=2$ ，故椭圆 $C$ 的方程为 $\frac{x^{2}}{8}+\frac{y^{2}}{2}=1$ .
