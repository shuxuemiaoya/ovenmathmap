---
answer_for: "Q00042535"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 78ad5aae039ec01eb857afca695b1cb215ee0947d50d3420a81081e9e21d0dc4
---
...
> >
> > 10. 解析
> > (1) $\because$ 椭圆 $\frac{x^2}{a^2} + \frac{y^2}{b^2} = 1 (a > b > 0)$ 的离心率为 $\frac{\sqrt{2}}{2}$ , $\therefore e^2 = \frac{c^2}{a^2} = \frac{a^2 - b^2}{a^2} = \frac{1}{2}$ , 得 $a^2 = 2b^2$ , ①
> >
