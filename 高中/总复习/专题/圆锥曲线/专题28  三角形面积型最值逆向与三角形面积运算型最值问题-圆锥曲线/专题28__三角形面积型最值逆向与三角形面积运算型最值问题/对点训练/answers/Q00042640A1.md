---
answer_for: "Q00042640"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 76afcb0dcf49a2ebbdca11de220772fbbc14530ed92827b730a2388b6498a362
---
...
> > 3. 解析
> > (1)由题意可得 $\left\{\begin{aligned}\frac{1}{a^{2}}+\frac{2}{3b^{2}}=1,\\ \frac{c}{a}=\frac{\sqrt{6}}{3},\\ a^{2}=b^{2}+c^{2},\end{aligned}\right.$ 解得 $a^{2}=3,\ b^{2}=1,\ \therefore\frac{x^{2}}{3}+y^{2}=1.$
