---
answer_for: "Q00042452"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: b3be3394bfa1f838c845f8d3f251c682e2213c5f256306d4479cceaebe1cf124
---
...
> >
> > 1. 解析
> > (1)由题设知 $F(1, 0)$ ，设直线 AB 的方程为 $x = my + 1 (m \in \mathbb{R})$ ， $A(x_{1}, y_{1})$ ， $B(x_{2}, y_{2})$ .
> >
...
> >
> > 由
> > (1)知， $y_{1}+y_{2}=-\frac{2m}{m^{2}+2}$ ， $y_{1}y_{2}=-\frac{1}{m^{2}+2}$ ，所以 $y_{1}+y_{2}=2my_{1}y_{2}$ . ②
> >
