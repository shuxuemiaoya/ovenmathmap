---
answer_for: "Q00042743"
answer_provenance: authoritative
answer_source_kind: "separate-authoritative"
answer_source_body_sha256: 3ae934ab878a6b022431a14c1b60a8f071e140c9f853dfd88fff5682766d3f88
---
...
> > 4. 解析
> > (1)由题意得 $\left\{ \begin{array}{l} c = \frac{\sqrt{2}}{2}, \\ \frac{1}{a^2} + \frac{1}{2b^2} = 1, \\ a^2 = b^2 + c^2, \end{array} \right.$ 解得 $\left\{ \begin{array}{l} a^2 = 2, \\ b^2 = 1. \end{array} \right.$ 所以椭圆 $E$ 的方程为 $\frac{x^2}{2} + y^2 = 1$ .
