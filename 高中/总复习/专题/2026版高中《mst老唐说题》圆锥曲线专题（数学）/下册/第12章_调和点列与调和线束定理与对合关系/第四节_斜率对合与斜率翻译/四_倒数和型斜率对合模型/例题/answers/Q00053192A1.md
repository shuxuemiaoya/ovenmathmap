---
answer_for: "Q00053192"
answer_provenance: authoritative
answer_source_kind: "worked-example"
answer_source_body_sha256: 363fe1574aeac02e4a83c31a5fa3b04f65b6aed298c6c9e3c98037f0be1a3a3d
---
> [!faq]- 《圆锥曲线专题(下册)》例题解析
>
> > [!success]- **【答案】** 详见解析
...
> >
> > 对合
> > 分析: 以 $P(2,1)$ 为对合中心, 我们求出它的对合轴方程 $\frac{2x}{4} + y = 1$ , 椭圆右顶点 $A$ 和上顶点 $B$ 的连线, $A$ 和 $B$ 是两个对合不动点, 因为 $BP \parallel x$ 轴, 以 $B$ 为射影中心, 所以一定有 $\frac{1}{k_1} + \frac{1}{k_2} = \frac{2}{k_3} = -4$
> >
