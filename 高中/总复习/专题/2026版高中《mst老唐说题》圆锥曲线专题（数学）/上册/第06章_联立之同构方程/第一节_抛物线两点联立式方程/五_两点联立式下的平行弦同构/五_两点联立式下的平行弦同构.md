...
$$
k _ {A B} = k _ {C D} = \frac {p}{y _ {0}}; (2) y _ {1} + y _ {2} = y _ {3} + y _ {4} = 2 y _ {0}; (3) y _ {1} y _ {2} = (1 + \lambda) y _ {0} ^ {2} - 2 \lambda p x _ {0}, y _ {3} y _ {4} = (1 + \frac {1}{\lambda}) y _ {0} ^ {2} - \frac {2 p x _ {0}}{\lambda};
$$
...
$$
(1) k _ {A B} = k _ {C D} = \frac {x _ {0}}{p}; (2) x _ {1} + x _ {2} = x _ {3} + x _ {4} = 2 x _ {0}; (3) x _ {1} x _ {2} = (1 + \lambda) x _ {0} ^ {2} - 2 \lambda p y _ {0}, x _ {3} x _ {4} = (1 + \frac {1}{\lambda}) x _ {0} ^ {2} - \frac {2 p y _ {0}}{\lambda};
$$

![[高中/总复习/专题/2026版高中《mst老唐说题》圆锥曲线专题（数学）/上册/第06章_联立之同构方程/第一节_抛物线两点联立式方程/五_两点联立式下的平行弦同构/例题/Q00053018.md]]
![[高中/总复习/专题/2026版高中《mst老唐说题》圆锥曲线专题（数学）/上册/第06章_联立之同构方程/第一节_抛物线两点联立式方程/五_两点联立式下的平行弦同构/例题/Q00053019.md]]
![[高中/总复习/专题/2026版高中《mst老唐说题》圆锥曲线专题（数学）/上册/第06章_联立之同构方程/第一节_抛物线两点联立式方程/五_两点联立式下的平行弦同构/例题/Q00053020.md]]
