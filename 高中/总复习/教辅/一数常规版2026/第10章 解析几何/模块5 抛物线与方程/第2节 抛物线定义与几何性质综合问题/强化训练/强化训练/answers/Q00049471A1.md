...
answer_source_body_sha256: 4d7c42d27fd7a6de6d333dd9d41131fa3e8e10f1bdb3933a304782b01567a0c8
---
...
>
> > [!note]- **【解析】**
> > $\frac{3}{4}$ 解法1：涉及 $|AF|$ 和 $|BF|$ ，考虑抛物线的定义，如图，作 $AA^{\prime} \perp$ 准线于 $A^{\prime}$ ， $BB^{\prime} \perp$ 准线于 $B^{\prime}$ ，则 $\left|AA^{\prime}\right| = \left|AF\right| = 7$ ， $\left|BB^{\prime}\right| = \left|BF\right| = 25$ ，因为 $FA \perp AB$ ，所以 $\left|AB\right| = \sqrt{\left|BF\right|^2 - \left|AF\right|^2} = \sqrt{25^2 - 7^2} = 24$ ，
> >
> > 由图可知直线 $AB$ 的倾斜角 $\theta = \angle ABB'$ ，于是构造一个直角三角形来求 $\angle ABB'$ ，作 $AH \perp BB'$ 于 $H$ ，则 $|BH| = |BB'| - |B'H| = |BB'| - |AA'|$ $= 18$ ，所以 $\cos \angle ABH = \frac{|BH|}{|AB|} = \frac{3}{4}$ ，故 $\cos \theta = \frac{3}{4}$ .
> >
