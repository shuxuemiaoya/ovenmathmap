...
answer_source_body_sha256: 7746be6da7ad908de3c41be16823480d4932fe85262cd1dea44eda48209572b2
---
> [!faq]- 《第1节 抛物线定义、标准方程及简单几何性质》例题解析
>
> > [!success]- **【答案】** $\frac{3\sqrt{2}}{2}$
>
> > [!note]- **【分析】**
> > 本题未单列分析。
>
...
> >
> > 当且仅当点 $P$ 为线段 $FQ$ 与抛物线交点 $P_0$ 时取等号，所以 $(d_{1} + d_{2})_{\mathrm{min}} = \frac{3\sqrt{2}}{2}$
> >
> >
