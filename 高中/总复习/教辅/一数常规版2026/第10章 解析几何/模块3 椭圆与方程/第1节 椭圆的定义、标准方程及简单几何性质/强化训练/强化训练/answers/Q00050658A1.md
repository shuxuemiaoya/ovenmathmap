...
answer_source_body_sha256: bf8431f0e3839e26ecd47624d1d4836224230c5f55ab846741d1c36ed011d16c
---
> [!faq]- 《第1节 椭圆的定义、标准方程及简单几何性质》参考答案
>
> > [!success]- **【答案】** (★★) 椭圆 $\frac{y^2}{a^2} +\frac{x^2}{b^2} = 1(a > b > 0)$ 的右顶点为 $A(1,0)$ ，过其焦点且垂直于长轴的弦长为1，则椭圆的方程为
>
> > [!note]- **【分析】**
> > 本题未单列分析。
>
