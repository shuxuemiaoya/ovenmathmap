...
answer_source_body_sha256: 92812b3b0c7125bb19ee58a82bbfd6cd660c998910498f0c75509dbb22986ea8
---
> [!faq]- 《第2节 椭圆的焦点三角形相关问题》参考答案
>
> > [!success]- **【答案】** 设 $P$ 是椭圆 $C: \frac{x^2}{a^2} + \frac{y^2}{b^2} = 1 (a > b > 0)$ 上一点， $F_1, F_2$ 是 $C$ 的两个焦点， $\overrightarrow{PF_1} \cdot \overrightarrow{PF_2} = 0$ ，点 $Q$ 在 $\angle F_1PF_2$ 的平分线上， $O$ 为原点， $OQ \parallel PF_1$ ，且 $|OQ| = b$ ，则 $C$ 的离心率为（） A. $\frac{1}{2}$ B. $\frac{\sqrt{3}}{3}$ C. $\frac{\sqrt{6}}{3}$ D. $\frac{\sqrt{3}}{2}$
>
> > [!note]- **【分析】**
> > 本题未单列分析。
>
