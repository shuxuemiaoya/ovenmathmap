...
![[高中/总复习/教辅/一数常规版2026/第4章 三角函数/模块1：同角三角函数关系与诱导公式/第2节 同角三角函数基本关系/类型01_正弦余弦正切相互转换/类型01_正弦余弦正切相互转换.md]]
![[高中/总复习/教辅/一数常规版2026/第4章 三角函数/模块1：同角三角函数关系与诱导公式/第2节 同角三角函数基本关系/类型02_正余弦和差与积的关系/类型02_正余弦和差与积的关系.md]]
![[高中/总复习/教辅/一数常规版2026/第4章 三角函数/模块1：同角三角函数关系与诱导公式/第2节 同角三角函数基本关系/类型03_齐次分式化正切/类型03_齐次分式化正切.md]]
