...
answer_source_body_sha256: 2ef02c9f6adb57d138e5725efc366675035e69a6e1b6f794749729b2891a68db
---
...
> >
> > 方程 $b = \mathrm{e}^{t}(a + 1 - t)$ 有2个实数解等价于直线 $y = b$ 与 $y = f(t)$ 的图象有2个交点，由图可知 $0 < b < \mathrm{e}^{a}$ . 解法2：观察选项B、D可发现，它们分别表示点 $(a, b)$ 在曲线 $y = \mathrm{e}^{x}$ 上方和点 $(a, b)$ 在曲线 $y = \mathrm{e}^{x}$ 与 $x$ 轴之间，故也可考虑直接画图分析怎样能过点 $(a, b)$ 作出曲线 $y = \mathrm{e}^{x}$ 的两条切线，
