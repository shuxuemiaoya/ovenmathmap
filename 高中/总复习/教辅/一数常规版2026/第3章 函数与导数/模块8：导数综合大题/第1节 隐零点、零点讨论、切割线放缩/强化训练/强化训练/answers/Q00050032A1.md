...
answer_source_body_sha256: 7378ed3c6d45e9bf8a9fa1b6db69190c03d6b385d89942305a2836bd3a2d2bac
---
...
>
> > [!note]- **【解析】**
> > 解：（1）（给了 $x = -\frac{1}{2}$ 处的切线方程，怎样翻译？可从两方面来看，一方面， $f'\left(-\frac{1}{2}\right)$ 等于所给切线的斜率，另一方面， $x = -\frac{1}{2}$ 处应为切线和函数 $f(x)$ 图象的交点，由此可建立两个关于 $a, b$ 的方程组，求出 $a$ 和 $b$ ）
