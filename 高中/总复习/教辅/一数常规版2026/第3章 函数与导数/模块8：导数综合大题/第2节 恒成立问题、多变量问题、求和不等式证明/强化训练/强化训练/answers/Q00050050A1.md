...
answer_source_body_sha256: c8d0cf98d8f4525024018252b85000e711a0e8e4bd0f5f59afb59435cf1f9a6e
---
...
>
> > [!note]- **【解析】**
> > 解：（1）当 $a = 1$ 时， $f(x) = \mathrm{e}^{x - 1} + x^2 - 3x + 1$ ，所以 $f'(x) = \mathrm{e}^{x - 1} + 2x - 3$ ，故 $f'(1) = 0$ ，又 $f(1) = 0$ ，所以曲线 $y = f(x)$ 在 $x = 1$ 处的切线方程是 $y - 0 = 0 \cdot (x - 1)$ ，整理得： $y = 0$ 。
> >
