...
answer_source_body_sha256: 1201186304f9c81ed0e5ecffead16d65b3b4b4ea83a067d5a7d0e34d275b9e75
---
> [!faq]- 《第1节 动态问题探究》例题解析
>
> > [!success]- **【答案】** C
...
> >
> > 现在就能分析 $S_{\triangle D_1C_1P}$ 何时最大了，由图1可知 $D_{1}C_{1}\bot C_{1}P$ 所以 $C_1P$ 最大时， $S_{\triangle D_1C_1P}$ 就最大，如图2，当 $P$ 与 $Q$ 重合时， $C_1P$ 最大，所以 $(S_{\triangle D_1C_1P})_{\mathrm{max}} = \frac{1}{2} D_1C_1\cdot C_1Q = \sqrt{5}.$
> >
> >
