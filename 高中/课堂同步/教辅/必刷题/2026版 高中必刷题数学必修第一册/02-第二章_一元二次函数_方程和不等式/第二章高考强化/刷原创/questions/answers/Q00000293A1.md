...
>
> **【解析】**
> 由题意, $m=4-2a+b$ , 令 $y=(x-c)(x-t)$ , 则由根与系数的关系知, $c+t=$ $p = \frac{ab + 2b}{a^2 + b^2 + 1} = \frac{ab + 2b}{a^2 + \frac{1}{5}b^2 + \frac{4}{5}b^2 + 1} \leqslant$ $\frac{ab + 2b}{2\sqrt{\frac{1}{5}}ab + 2\sqrt{\frac{4}{5}}b} = \frac{\sqrt{5}}{2},$ 当且仅当 $\begin{cases} a^2 = \frac{1}{5}b^2, \\ \frac{4}{5}b^2 = 1, \end{cases}$ 即 $\begin{cases} a = \frac{1}{2}, \\ b = \frac{\sqrt{5}}{2} \end{cases}$ 时，等号成立.
