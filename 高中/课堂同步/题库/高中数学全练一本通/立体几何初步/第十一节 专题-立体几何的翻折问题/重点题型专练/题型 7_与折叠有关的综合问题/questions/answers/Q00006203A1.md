...
当面 $PBD \perp$ 面 $BCD$ 时，此时四面体 $PBCD$ 的体积最大，此时的体积为： $V = \frac{1}{3} S_{\triangle BCD} \cdot PM = \frac{1}{3} \times (\frac{1}{2} \times \sqrt{2} \times \sqrt{2}) \times \sqrt{3} = \frac{\sqrt{3}}{3}$ ，故 D 正确故选：C
