...
> [!faq]- 全练一本通解析
> **【解析】**
> $\frac{\sqrt{3}}{3}$ 解析: 取 $AC$ 的中点 $M$ , 连接 $D_1M$ , 与 $DB_1$ 交于点 $G$ . 因为 $AC \perp$ 平面 $BB_1D_1D$ , $B_1G \subset$ 平面 $BB_1D_1D$ , 则 $AC \perp B_1G$ . 通过垂直判定定理可证 $CD_1 \perp$ 平面 $B_1C_1D$ 所以 $CD_1 \perp B_1G$ , $AC \cap CD_1 = C$ , $AC, CD_1 \subset$ 平面 $ACD_1$ ,
