...
> [!faq]- 全练一本通解析
> **【解析】**
> (1) $[2, +\infty)$ ; (2) $(- \infty, -2] \cup [2, +\infty)$ ; (3) $[2, +\infty)$ ; (4) $[2\sqrt{2} - 1, +\infty)$ ; (5) $\left[\frac{11}{2}, 8\right]$ ; (6) $[-10, -8]$ ; (7) $\left[4, \frac{37}{3}\right]$ ; (8) $[3, +\infty)$ ; (9) $(- \infty, 2]$ 解析：（1）由基本不等式可知 $y = x + \frac{1}{x} \geq 2\sqrt{x \cdot \frac{1}{x}} = 2, x \in (0, +\infty)$ ，当且仅当 $x = \frac{1}{x} = 1$ 时取等号. 故取值范围为： $[2, +\infty)$
