...
> [!faq]- 全练一本通解析
> **【答案】** $\left[\sqrt{6} -1,\sqrt{6} +1\right]$
>
> **【解析】**
> $\because \overrightarrow{OA}\cdot \overrightarrow{OB} = 1,\therefore \sqrt{2}\times \sqrt{2}\times \cos <  \overrightarrow{OA},\overrightarrow{OB} > = 1,\therefore \cos <  \overrightarrow{OA},\overrightarrow{OB} > = \frac{1}{2}$
