...
> [!faq]- 全练一本通解析
> **【答案】** $y=\pm\frac{\sqrt{6}}{2}x$
>
> **【解析】**
> 由 $\overrightarrow{AF_{1}}\cdot\overrightarrow{BF_{1}}=0$ 可得 $\overrightarrow{AF_{1}}\perp\overrightarrow{BF_{1}}$ 由于 A, B 关于原点 O 对称， $F_{1}$ ， $F_{2}$ 关于原点 O 对称，
