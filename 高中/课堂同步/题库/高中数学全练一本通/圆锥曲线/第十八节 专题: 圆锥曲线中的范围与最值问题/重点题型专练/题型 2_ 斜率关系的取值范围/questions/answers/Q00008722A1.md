...
> [!faq]- 全练一本通解析
> **【解析】**
> （1） $\frac{x^2}{4} + \frac{y^2}{3} = 1$ （2） $\left(-\infty, -\frac{\sqrt{15}}{5}\right) \cup \left(\frac{\sqrt{15}}{5}, +\infty\right)$ 解析：（1）由题意可知： $|PQ| + |QF_1| = |PF_1| = r = 4$ ，由 $F_2P$ 的中垂线 $l$ 交 $F_1P$ 于点 $Q$ ，则 $\left|QF_2\right| = |PQ|$ ， $\therefore |QF_2| + |QF_1| = 4 > |F_1F_2| = 2$ ，则点 $Q$ 的轨迹 $E$ 为以 $F_1$ ， $F_2$ 为焦点，4为长轴长的椭圆，即 $2a = 4$ ， $2c = 2$ ， $b^2 = a^2 - c^2 = 3$ ，∴ 点 $Q$ 的轨迹 $E$ 的方程为： $\frac{x^2}{4} + \frac{y^2}{3} = 1$ ；
