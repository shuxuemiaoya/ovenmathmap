...
> [!faq]- 全练一本通解析
> **【答案】** （1） $y=\pm\sqrt{3}(x-1)$ ; （2） $\Gamma:\frac{x^{2}}{4}+\frac{y^{2}}{3}=1(x\neq\pm2)$ ; （3）4
>
> **【解析】**
> （1）设直线 $l_{1}$ 的斜率为 k，直线方程为 $y=k(x-1)$ ，因为 $A_{1}$ 到直线 $l_{1}$ 的距离为 $\sqrt{3}$ ，则 $d=\frac{|-2k|}{\sqrt{k^{2}+1}}=\sqrt{3}$ ，解得 $k=\pm\sqrt{3}$ ，所以直线 $l_{1}$ 的方程为 $y=\pm\sqrt{3}(x-1)$ .
