...
> [!faq]- 全练一本通解析
> **【答案】** （1） $\frac{x^{2}}{2}+y^{2}=1$ ; $e=\frac{\sqrt{2}}{2}$ . （2）点 D 在定直线 $y=\frac{1}{2}$ 上
>
> **【解析】**
> （1）由椭圆的定义知， $\left|MF_{1}\right|+\left|MF_{2}\right|=2\sqrt{2}=2\sqrt{m}$ ，故 m=2，所以椭圆 C 的方程为 $\frac{x^{2}}{2}+y^{2}=1$ ，故 $a=\sqrt{2}, b=1, c=\sqrt{a^{2}-b^{2}}=1$ ，所以椭圆 C 的离心率为 $e=\frac{c}{a}=\frac{1}{\sqrt{2}}=\frac{\sqrt{2}}{2}$ .
