...
> [!faq]- 全练一本通解析
> **【解析】**
> （1） $x^{2}-\frac{y^{2}}{3}=1$ （2）证明见解析，直线方程为 $x=\frac{1}{2}$ 解析：（1）由题意得 $A_{1}(-a,0),A_{2}(a,0),F_{1}(-c,0),F_{2}(c,0)$ ，因为 $\left|A_{1}F_{2}\right|=3\left|A_{2}F_{2}\right|$ ，所以 $c+a=3(c-a)$ ，解得c=2a，
