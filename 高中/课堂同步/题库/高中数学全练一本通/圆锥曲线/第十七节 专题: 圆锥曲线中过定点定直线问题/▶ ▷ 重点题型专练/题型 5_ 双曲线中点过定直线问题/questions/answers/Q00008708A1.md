...
> [!faq]- 全练一本通解析
> **【解析】**
> （1） $x^2 + \left(y - \frac{3}{2}\right)^2 = \frac{25}{4}$ （2）证明见解析
> 解析：（1）由双曲线 $C: \frac{x^2}{a^2} - \frac{y^2}{b^2} = 1$ 的左、右焦点分别为 $F_1(-c,0), F_2(c,0)$ ，直线 $y = 3$ 与 $C$ 的左、右两支分别交于 $M, N$ 两点，且四边形 $MF_1F_2N$ 为矩形，
