...
> [!faq]- 全练一本通解析
> **【答案】** （1） $C:y^{2}=2x$ （2）直线l过定点(3,0)
>
> **【解析】**
> （1）依题意可得 $\left\{\begin{aligned}&2pm=1\\ &m+\frac{p}{2}=1\end{aligned}\right.$ ，解得 $\left\{\begin{aligned}m=0.5\\ p=1\end{aligned}\right.$ ，所以抛物线方程为： $C:y^{2}=2x$ ；
