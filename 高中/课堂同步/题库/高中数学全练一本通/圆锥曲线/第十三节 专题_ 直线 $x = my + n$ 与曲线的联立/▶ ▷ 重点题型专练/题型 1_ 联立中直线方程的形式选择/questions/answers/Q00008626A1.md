...
> [!faq]- 全练一本通解析
> **【答案】** （1） $3x - 2y - 4 = 0$ （2）证明见解析
>
> **【解析】**
> （1）设 $A(x_{1},y_{1})$ ， $B(x_{2},y_{2})$ ，则有 $\left\{ \begin{array}{l} x_{1} + x_{2} = 2 \\ y_{1} + y_{2} = -1 \end{array} \right.$ 且 $\left\{ \begin{array}{l}\frac{x_1^2}{4} + \frac{y_1^2}{3} = 1 \\ \frac{x_2^2}{4} + \frac{y_2^2}{3} = 1 \\ \frac{x_3^2}{4} + \frac{y_3^2}{3} = 1 \end{array} \right.$ ，作差可得 $\frac{(x_1 + x_2)(x_1 - x_2)}{4} + \frac{(y_1 + y_2)(y_1 - y_2)}{3} = 0$ ，
