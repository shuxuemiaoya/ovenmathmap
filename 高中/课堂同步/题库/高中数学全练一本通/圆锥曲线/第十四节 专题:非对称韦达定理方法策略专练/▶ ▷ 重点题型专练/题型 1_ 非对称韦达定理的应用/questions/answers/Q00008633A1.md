...
> [!faq]- 全练一本通解析
> **【解析】**
> （1） $\frac{x^{2}}{4}+\frac{y^{2}}{3}=1$ （2）椭圆 C 具有“过中”性质，理由见解析
> 解析：（1）由题意， $\left\{\begin{aligned}\frac{\left(\sqrt{2}\right)^{2}}{a^{2}}+\frac{\left(\frac{\sqrt{6}}{2}\right)^{2}}{b^{2}}=1,\text { 解得 }a^{2}=4,b^{2}=3,\end{aligned}\right.$
