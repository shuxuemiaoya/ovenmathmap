...
> [!faq]- 全练一本通解析
> **【解析】**
> （1） $\frac{x^{2}}{2}-\frac{y^{2}}{2}=1$ ；（2）存在；点 $N(1,0)$ ， $\overrightarrow{NA}\cdot\overrightarrow{NB}=-1$
> 解析：（1）由双曲线得渐近线方程为 $bx \pm \sqrt{2}y = 0$ ，设 $F(c,0)$ ，则 $d = \frac{|bc|}{\sqrt{2 + b^2}} = \frac{bc}{c} = b = \sqrt{2}$ ，
