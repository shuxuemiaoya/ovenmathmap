...
> [!faq]- 全练一本通解析
> **【答案】** （1） $\frac{x^{2}}{4}-\frac{y^{2}}{4}=1$ ；（2）证明见解析.
>
> **【解析】**
> （1）因为 E 是关于 x 轴和 y 轴均对称的等轴双曲线，故可设其方程为 $x^{2}-y^{2}=\lambda$ 又 E 经过点 $(4,2\sqrt{3})$ ，所以 $\lambda=4^{2}-(2\sqrt{3})^{2}=4$ 所以 E 的方程为 $x^{2}-y^{2}=4$ ，即 $\frac{x^{2}}{4}-\frac{y^{2}}{4}=1$ 。
