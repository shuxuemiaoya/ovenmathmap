...
> [!faq]- 全练一本通解析
> **【解析】**
> （1） $\frac{x^2}{4} + \frac{y^2}{3} = 1$ （2） $\left(-1, \frac{1}{2}\right)$ 解析：（1）依题意得： $c = 1$ $\because e = \frac{c}{a}$ ，即 $\frac{1}{2} = \frac{1}{a}$ ，解得 $a = 2$ $\because b^2 = a^2 - c^2$ ，解得 $b = \sqrt{3}$ $\therefore$ 椭圆 $C$ 的方程为 $\frac{x^2}{4} + \frac{y^2}{3} = 1$
> (2) 如图所示:
