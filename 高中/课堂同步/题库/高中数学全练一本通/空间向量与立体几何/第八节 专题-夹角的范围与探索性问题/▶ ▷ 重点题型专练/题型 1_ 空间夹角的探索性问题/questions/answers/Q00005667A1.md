...
> [!faq]- 全练一本通解析
> **【解析】**
> （1）证明见解析（2）存在, $m = \frac{1}{2}$
解析：（1）在 $\triangle ABC$ 中，由余弦定理得 $AC^2 = \sqrt{3}^2 + 1^2 - 2 \times \sqrt{3} \times 1 \times \frac{\sqrt{3}}{2} = 1$ ， $\therefore AC^2 + BC^2 = 1^2 + \sqrt{3}^2 = 4 = AB^2$ ， $\therefore CB \perp CA$
$$
A M \perp P C
$$
$$
