...
>
> **【解析】**
> 为 PD 上靠近 D 的三等分点，理由见解析
解析：∵ PA⊥平面 ABCD，四边形 ABCD 为矩形，∴ PA, AB, AD 两两互相垂直，则以 A 为坐标原点， $\overrightarrow{AB},\overrightarrow{AD},\overrightarrow{AP}$ 正方向为 x,y,z 轴可建立空间直角坐标系，
