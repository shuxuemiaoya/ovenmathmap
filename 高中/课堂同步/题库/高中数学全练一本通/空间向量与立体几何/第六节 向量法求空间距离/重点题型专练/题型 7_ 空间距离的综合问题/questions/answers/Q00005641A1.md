...
> [!faq]- 全练一本通解析
> **【解析】**
> （1）证明见解析（2） $\sqrt{2}$ 解析：（1）由题意知， $AA_{1} \perp$ 平面 $ABC$ ， $\angle BAC = 60^{\circ}$ ，而 $AB \subset$ 平面 $ABC$ ，所以 $AA_{1} \perp AB$ ，在平面 $ABC$ 内过点 $A$ 作 $y$ 轴，使得 $AB \perp y$ 轴，建立如图空间直角坐标系 $A - xyz$ ，
