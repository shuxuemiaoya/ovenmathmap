...
> **【解析】**
> $\vec{n} = (0, -\sqrt{3}, 1)$
解析: 因为 $AB_{1} \perp$ 平面 ABC，所以 $AB_{1} \perp AB$ 因为 AB = 1, $BB_{1} = 2$ , $\therefore AB_{1}=\sqrt{3}$ 如图，以 A 为原点， $\overline{AB},\overline{AC},\overline{AB_{1}}$ 的方向分别为 x 轴，y 轴，z 轴的正方向建立空间直角坐标系，
