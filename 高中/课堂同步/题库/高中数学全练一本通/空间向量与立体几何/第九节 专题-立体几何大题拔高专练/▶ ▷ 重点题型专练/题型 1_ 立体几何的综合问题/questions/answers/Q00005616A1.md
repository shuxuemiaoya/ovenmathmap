...
> [!faq]- 全练一本通解析
> **【解析】**
> （1） $\frac{32\sqrt{5}}{3}$ （2） $\frac{1 + \sqrt{5}}{4}$
解析：（1）由题意 $D_{1}H_{1}\perp$ 平面 $EFGH,PH_1\subset$ 平面 $EFGH$ ，所以 $D_{1}H_{1}\perp PH_{1}$ ，又因为 $\tan \angle D_1PH_1 = \frac{2}{3}$ 得 $\frac{D_1H_1}{PH_1} = \frac{2}{3}$ ，所以 $PH_{1} = 6$ 因为 $PG = 2\sqrt{5},GH_{1} = 4,PH_{1} = 6$
