---
answer_for: "Q00080092"
answer_provenance: authoritative
answer_source_kind: "numbered-exercise"
answer_source_body_sha256: 33b6aedf57d61120f386730b6c8afdeace9b28d17a688232a22b846e649ef69f
---

> [!faq]- 《专题03 抛物线的四大常考题型（高效培优专项训练）》官方解析
>
> > [!success]- **【答案】** A. $y = \frac{1}{3} x^2 - \frac{4}{3} x + \frac{2}{3}$ B. $y = \frac{4}{3} x^2 - \frac{1}{3} x + \frac{2}{3}$ C. $y = \frac{2}{3} x^2 - \frac{1}{3} x + \frac{4}{3}$ D. $y = \frac{4}{3} x^2 - \frac{2}{3} x + \frac{1}{3}$
>
> > [!note]- **【解析】**
