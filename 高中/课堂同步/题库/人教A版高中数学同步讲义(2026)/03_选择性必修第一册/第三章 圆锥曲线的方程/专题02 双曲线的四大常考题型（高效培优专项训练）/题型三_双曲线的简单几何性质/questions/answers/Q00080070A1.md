---
answer_for: "Q00080070"
answer_provenance: authoritative
answer_source_kind: "numbered-exercise"
answer_source_body_sha256: 289810e5ae47694f9ff0c6ab847ffe419d92df0c4a25024a669f79da2ea926ad
---

> [!faq]- 《专题02 双曲线的四大常考题型（高效培优专项训练）》官方解析
>
> > [!success]- **【答案】** ①点集 M 表示的图形关于 x 轴对称 ②存在点 $P$ 和点 $Q$ ，使得 $AP \perp AQ$ ③若直线 $PQ$ 经过点 $\left(\sqrt{2} - 1,0\right)$ ，则 $|PQ|$ 的最小值为 2 ④若直线 $PQ$ 经过点 $(1,0)$ ，且 $\triangle OPQ$ 的面积为 $\sqrt{5}$ ，则直线 $PQ$ 的方程为 $x \pm \sqrt{2}y - 1 = 0$ A. 1个 B. 2个 C. 3个 D. 4个
>
> > [!note]- **【解析】**
