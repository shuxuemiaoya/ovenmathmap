---
answer_for: "Q00079496"
answer_provenance: authoritative
answer_source_kind: "numbered-exercise"
answer_source_body_sha256: a6657e89d6e3cff14e1fad948221642389bd69274db4f6b00a77e2e669c21a43
---

> [!faq]- 《专题10 椭圆标准方程及其性质全方位总结（九大题型）（高效培优期中专项训练）数学人教A版2019高二选择性必修第一册》官方解析
>
> > [!success]- **【答案】** A．存在点P，使得 $\angle F_{1}PF_{2}=90^{\circ}$ B．满足 $\triangle F_{1}PF_{2}$ 为等腰三角形的点P有2个 C．若 $\angle F_{1}PF_{2}=60^{\circ}$ ，则 $\triangle F_{1}PF_{2}$ 的面积为 $\frac{\sqrt{3}}{3}$ D $1\leq |AB|\leq 4$
>
> > [!note]- **【分析】**
