---
answer_for: "Q00079935"
answer_provenance: authoritative
answer_source_kind: "numbered-exercise"
answer_source_body_sha256: fc6f2d6c69eb7d90ba804fb9b9b61681e833c32222048add21a1217dc3521901
---

> [!faq]- 《第一章 空间向量与立体几何（高效培优单元测试·强化卷）》官方解析
>
> > [!success]- **【答案】** 棱 $A_{1}B_{1}$ 上的动点，则下列结论正确的是（ ）A.存在点 $M$ ，使得 $C_1M\perp A_1B$ B. $A_{1}B$ 与 $CB_{1}$ 所成角的正弦值为 $\frac{\sqrt{70}}{10}$ C.三棱锥 $M - BCN$ 的体积为一个定值 D.三棱锥 $B - ACN$ 的外接球表面积为 $3\pi$
>
> > [!note]- **【分析】**
