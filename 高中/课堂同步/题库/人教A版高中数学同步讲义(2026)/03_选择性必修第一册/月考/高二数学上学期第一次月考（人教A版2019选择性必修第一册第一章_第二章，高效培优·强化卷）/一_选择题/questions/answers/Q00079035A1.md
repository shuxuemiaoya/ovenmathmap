---
answer_for: "Q00079035"
answer_provenance: authoritative
answer_source_kind: "numbered-exercise"
answer_source_body_sha256: 3b16fd0fa9f452ebf5ca4e4efce0f9b7fe373315660987beb9a8667ed872d22e
---

> [!faq]- 《高二数学上学期第一次月考（人教A版2019选择性必修第一册第一章_第二章，高效培优·强化卷）》官方解析
>
> > [!success]- **【答案】** ( ) A. 直线 $C_1 C_2$ 恒过定点 $(3,0)$ B．当圆 $C_1$ 和圆 $C_2$ 有三条公切线时，若 $P, Q$ 分别是圆 $C_1, C_2$ 上的动点，则 $\left|PQ\right|_{\max} = 10$ C．若圆 $C_{1}$ 和圆 $C_{2}$ 共有2条公切线，则 $a<\frac{4}{3}$ D．当 $a=\frac{1}{3}$ 时，圆 $C_{1}$ 与圆 $C_{2}$ 相交弦的弦长为 $\frac{3\sqrt{6}}{2}$
>
> > [!note]- **【解析】**
