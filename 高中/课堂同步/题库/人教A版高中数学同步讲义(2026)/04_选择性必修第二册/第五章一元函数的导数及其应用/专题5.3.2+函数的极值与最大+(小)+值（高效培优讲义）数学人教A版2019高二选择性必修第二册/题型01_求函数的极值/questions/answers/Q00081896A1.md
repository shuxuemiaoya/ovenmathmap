---
answer_for: "Q00081896"
answer_provenance: authoritative
answer_source_kind: "variant-example"
answer_source_body_sha256: 64867b35681b7d1487afc507b7cea5643f0f330957291b3b908a5fdf5f2aa9ec
---

> [!faq]- 《专题5.3.2+函数的极值与最大+(小)+值（高效培优讲义）数学人教A版2019高二选择性必修第二册》官方解析
>
> > [!success]- **【答案】** (1)函数 $f(x)$ 的极大值点为 x=1 ，函数 $f(x)$ 没有极小值点； (2) $1 < a \leq e - \frac{1}{e}$ .
>
> > [!note]- **【分析】**
> > （1）由题可得 $f(x)$ 单调性，据此可得 $f(x)$ 的极值点；
> >
