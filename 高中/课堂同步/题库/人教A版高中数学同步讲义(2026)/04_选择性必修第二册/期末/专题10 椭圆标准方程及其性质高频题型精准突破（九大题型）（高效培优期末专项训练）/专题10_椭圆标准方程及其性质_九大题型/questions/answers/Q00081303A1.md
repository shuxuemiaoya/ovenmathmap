---
answer_for: "Q00081303"
answer_provenance: authoritative
answer_source_kind: "numbered-exercise"
answer_source_body_sha256: 48168d5db2aec1cac3055ae3801bc68c2db9e4d56745f41d3914023b4a436f0c
---

> [!faq]- 《专题10 椭圆标准方程及其性质高频题型精准突破（九大题型）（高效培优期末专项训练）》官方解析
>
> > [!success]- **【答案】** A. 若 $C$ 的离心率为 $\frac{1}{2}$ ，则直线 $PA_1$ 与 $PA_2$ 的斜率之积为 $-\frac{4}{3}$ B. 若 $PF_{1} \perp PF_{2}$ , 则 $\triangle PF_{1}F_{2}$ 的面积为 $b^{2}$ C. 若 $C$ 上存在四个点 $P$ 使得 $PF_{1} \perp PF_{2}$ ，则 $C$ 的离心率的范围是 $\left(0, \frac{\sqrt{2}}{2}\right)$ D．若 $\left|PF_{1}\right|\leq2b$ 恒成立，则C的离心率的范围是 $\left(0,\frac{3}{5}\right]$
>
> > [!note]- **【分析】**
