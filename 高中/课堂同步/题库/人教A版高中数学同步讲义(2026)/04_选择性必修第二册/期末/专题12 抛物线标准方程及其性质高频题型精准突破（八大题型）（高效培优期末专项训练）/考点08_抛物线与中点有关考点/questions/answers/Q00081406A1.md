---
answer_for: "Q00081406"
answer_provenance: authoritative
answer_source_kind: "numbered-exercise"
answer_source_body_sha256: 10c9df9c81f416d06c5e7c9debd65d475eb41b00c77962da895d724f404f3628
---

> [!faq]- 《专题12 抛物线标准方程及其性质高频题型精准突破（八大题型）（高效培优期末专项训练）》官方解析
>
> > [!success]- **【答案】** A. 若 $P$ 在半圆 $O_{1}$ 上，则 $P$ 到直线 $O_{2}F$ 的距离最大值为 $\frac{12\sqrt{13}}{13} + 2$ B. 若 $P$ 在半圆 $O_{2}$ 上，则 $\left|PN\right| + \left|FN\right|$ 的最小值为 5 C. 若 $\overline{MN} = \lambda \overline{MF}$ ，则 $\triangle PMN$ 的面积的最大值为 7 D. 若 $P$ 在半圆 $O_{1}$ 上， $Q(1,1)$ 是 $MN$ 的中点，则 $\overline{PM} \cdot \overline{PN}$ 的最大值为 $4\sqrt{10} + \frac{41}{4}$ .
>
> > [!note]- **【分析】**
