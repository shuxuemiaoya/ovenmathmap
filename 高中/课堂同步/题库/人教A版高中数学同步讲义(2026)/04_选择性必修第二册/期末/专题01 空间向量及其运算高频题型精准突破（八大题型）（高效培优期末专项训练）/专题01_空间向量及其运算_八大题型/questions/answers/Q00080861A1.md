---
answer_for: "Q00080861"
answer_provenance: authoritative
answer_source_kind: "numbered-exercise"
answer_source_body_sha256: 7f1a2a929eae462e93311d690fe42c534c7ad7814b097c46973febfeea31bb00
---

> [!faq]- 《专题01 空间向量及其运算高频题型精准突破（八大题型）（高效培优期末专项训练）》官方解析
>
> > [!success]- **【答案】** ![](../../../images/questions/part-001/74eb9054d3e7f702b4ac41ca295b9e8cfd1980cdcf1d3759f5eeed37cc93306d.jpg) A. 当 $\lambda=\frac{1}{2}$ 时， $PQ \parallel A_{1}D$ B. 当 $\lambda = \frac{1}{2}$ 时，若 $PQ = xAB + yAD + zAA_{1}(x, y, z \in \mathbf{R})$ ，则 $x + y + z = 0$ C. 当 $\lambda = \frac{1}{3}$ 时，直线 $PQ$ 与直线 $CC_{1}$ 所成角的大小为 $\frac{\pi}{6}$ D. 当 $\lambda \in (0,1)$ 时，三棱锥 $Q - BCP$ 的体积的最大值为 $\frac{\sqrt{3}}{48}$
>
> > [!note]- **【分析】**
