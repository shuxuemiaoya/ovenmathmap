...
![[课本/【人教版】高中必修 第一册数学电子课本/例题/例题 通过图象变换得到 y = A sin(ωx + φ)的图象-例1 画出函数 y = 2 sin left(3x - .md]]

![[课本/【人教版】高中必修 第一册数学电子课本/例题/例题 通过图象变换得到 y = A sin(ωx + φ)的图象-例2 摩天轮是一种大型转轮状的机械建筑设施 游客坐在摩天.md]]
