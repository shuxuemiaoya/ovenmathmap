...
> **【解析】**
> $\frac{3\sqrt{10}}{10}$
解析:由 ABCD 为矩形可知: $BC \perp CD$ , 又因为 $BC \perp DE, DE \cap CD = D,$ CD, DE ⊂ 平面 PCD, 所以 BC ⊥ 平面 PCD, 可知 $BC \perp PC, BC = AD = 2,$ PB = 3, 所以 $PC = \sqrt{5}$ , 在 $\triangle PCD$ 中, $PC^{2}=PD^{2}+CD^{2}$ , 所以 $PD \perp CD$ ;
