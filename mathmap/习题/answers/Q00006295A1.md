...
故其体积的最大值 $V = \frac{1}{3} S_{\triangle SAD} \times h = \frac{1}{3} \times \frac{1}{2} \times AD \times SM \times (1 + \sqrt{2})$ $= \frac{1}{3} \times \frac{1}{2} \times 2 \times 1 \times (1 + \sqrt{2}) = \frac{1 + \sqrt{2}}{3}$ . 故选: D.
