...
> **【解析】**
> $\frac{60}{13}$
解析: 因为平面 $\alpha \parallel$ 平面 $A_{1}D_{1}CB$ ， $AD \subset$ 平面 $\alpha$ ，所以 AD 到平面 $A_{1}D_{1}CB$ 的距离即为平面 $\alpha$ 与平面 $A_{1}D_{1}CB$ 间的距离，易知 $AD \parallel$ 平面 $A_{1}D_{1}CB$ ，从而点 A 到平面 $A_{1}D_{1}CB$ 的距离即为所求的距离。
