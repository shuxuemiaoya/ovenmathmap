...
> [!faq]- 全练一本通解析
> **【解析】**
> $\left(\sqrt{3},2,-2\right)$
解析: 连接 PF, CF，因为 $\triangle PAB$ 是边长为 1 的正三角形，PA = PB，F 为 AB 的中点，所以 $PF \perp AB$ ，又因为平面 $PAB \perp$ 平面 ABCD，平面 $PAB \cap$ 平面 ABCD = AB， $PF \subset$ 平面 PAB，所以 $PF \perp$ 平面 ABCD。
