...
> **【解析】**
> （1）证明见解析（2） $\sqrt{2}$
解析：（1）因为四边形ABCD为正方形， $DE\bot$ 平面ABCD，如图以 $D$ 为原点，分别以 $DA,DC,DE$ 的方向为 $x,y,z$ 轴的正方向，建立空间直角坐标系，则 $D(0,0,0),A(2,0,0),B(2,2,0),C(0,2,0),E(0,0,2),F\left(2,2,\frac{1}{2}\right)$
