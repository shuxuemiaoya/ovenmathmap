...
> [!faq]- 全练一本通解析
> **【解析】**
> （1） $\overrightarrow{MN}=-\frac{2}{3}\overrightarrow{OA}+\frac{1}{2}\overrightarrow{OB}+\frac{1}{2}\overrightarrow{OC};(2)\left|\overrightarrow{MN}\right|=\frac{\sqrt{22}}{3}$ 解析：（1）∵OM=2MA,BN=CN，
