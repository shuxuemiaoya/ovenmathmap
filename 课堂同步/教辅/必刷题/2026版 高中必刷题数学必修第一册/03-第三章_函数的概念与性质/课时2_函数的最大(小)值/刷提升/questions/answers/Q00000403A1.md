> [!faq]- 必刷题解析
> **【解析】**
> 【解】(1)由函数 $f(x)=\frac{x+b}{x^{2}+a}$ 满足 $f(0)=0,f(1)=\frac{1}{5},$ 可得 $\left\{\begin{aligned}\frac{0+b}{0^{2}+a}&=0,\\ \frac{1+b}{1^{2}+a}&=\frac{1}{5},\end{aligned}\right.$ 解得 $\left\{\begin{aligned}b&=0,\\ a&=4,\end{aligned}\right.$ 则 $f(x)=\frac{x}{x^{2}+4}.$ $f(x)$ 在 $[-2,2]$ 上单调递增，证明如下：
